...
public class BlockBoxH_TRed extends BlockBox_TRed {

	public BlockBoxH_TRed(String unlocalizedName) {
	...
	public List<ItemStack> getDrops(IBlockAccess world, BlockPos pos, IBlockState state, int fortune) {
		List<ItemStack> stack = new ArrayList<ItemStack>();
	        ...
	        stack.add(new ItemStack(ASDecoModPantry.CANTEA, 8, this.damageDropped(state)));
	        return stack;
