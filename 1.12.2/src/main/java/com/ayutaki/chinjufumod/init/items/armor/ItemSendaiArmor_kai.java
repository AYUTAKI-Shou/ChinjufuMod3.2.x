...
import com.ayutaki.chinjufumod.init.items.armor.model.ModelSendaiBody;
...
public class ItemSendaiArmor_kai extends ItemArmor {
	...
	public ItemSendaiArmor_kai(int renderIndexIn, EntityEquipmentSlot equipmentSlotIn) {
		super(ChinjufuModArmorMaterial.SENDAI, renderIndexIn, equipmentSlotIn);
	...
	public void onArmorTick(World world, EntityPlayer player, ItemStack armor) {
		...
		if(this != ChinjufuModArmor.SENDAI_BOOTS_KAI) {}
