...
public class BlockBoxD_Corn extends BlockBox_Corn {

	public BlockBoxD_Corn(String unlocalizedName) {
	...
	public List<ItemStack> getDrops(IBlockAccess world, BlockPos pos, IBlockState state, int fortune) {
		List<ItemStack> stack = new ArrayList<ItemStack>();
	        ...
	        stack.add(new ItemStack(ChinjufuModItemFoods.FOOD_CORN, 16, this.damageDropped(state)));
	        return stack;
	...
	public ItemStack getPickBlock(IBlockState state, RayTraceResult target, World world,
		...
		return new ItemStack(ASDecoModPantry.BOX_H_CORN);
	}
