...
public class BlockChicken_4 extends BlockFacingSapo {
	...
	public boolean onBlockActivated(World worldIn, BlockPos pos, IBlockState state, EntityPlayer playerIn,
		...
		if (item != TTimeItems.Item_SARA) {
			...
			if (itemstack.isEmpty()) {
				...
				.addItemStackToInventory(new ItemStack(Item.getItemFromBlock(ChinjufuModFoodBlocks.CHICKENB_1)));
			...
			return worldIn.setBlockState(pos, ChinjufuModFoodBlocks.CHICKEN_kara
