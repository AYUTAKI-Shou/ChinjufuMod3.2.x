...
public class Lit_Ishitourou extends Block {
	...
	public boolean onBlockActivated(World worldIn, BlockPos pos, IBlockState state, EntityPlayer playerIn,
		...
		if (itemstack.isEmpty()) {
			...
			return worldIn.setBlockState(pos, ASDecoModGarden.ISHITOUROU_stone.getDefaultState());
		}
		return true;
	}
	...
	public List<ItemStack> getDrops(IBlockAccess world, BlockPos pos, IBlockState state, int fortune) {
		List<ItemStack> stack = new ArrayList<ItemStack>();
			...
			stack.add(new ItemStack(ASDecoModGarden.ISHITOUROU_stone, 1, this.damageDropped(state)));
	...
	public ItemStack getPickBlock(IBlockState state, RayTraceResult target, World world, BlockPos pos, EntityPlayer player) {
		return new ItemStack(ASDecoModGarden.ISHITOUROU_stone);
	}
}
