...
public class BlockWP_redsand_stone extends BlockFacingSapo {
	...
	public static final PropertyInteger PIL = PropertyInteger.create("pil", 1, 3);

	public BlockWP_redsand_stone(Material material) {
