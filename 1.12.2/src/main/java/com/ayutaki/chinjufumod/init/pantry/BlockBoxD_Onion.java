...
public class BlockBoxD_Onion extends BlockBox_Onion {

	public BlockBoxD_Onion(String unlocalizedName) {
	...
	public List<ItemStack> getDrops(IBlockAccess world, BlockPos pos, IBlockState state, int fortune) {
		List<ItemStack> stack = new ArrayList<ItemStack>();
	        ...
	        stack.add(new ItemStack(ChinjufuModItemFoods.FOOD_ONION, 16, this.damageDropped(state)));
	        return stack;
	...
	public ItemStack getPickBlock(IBlockState state, RayTraceResult target, World world,
		...
		return new ItemStack(ASDecoModPantry.BOX_H_ONION);
	}
