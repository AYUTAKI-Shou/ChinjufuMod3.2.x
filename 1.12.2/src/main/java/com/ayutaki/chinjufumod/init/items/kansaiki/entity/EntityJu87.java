...
public class EntityJu87 extends KansaikiThrowable {

	public static final DataParameter<Float> THROWER_X = EntityDataManager.<Float>createKey(EntityJu87.class,
			DataSerializers.FLOAT);
	public static final DataParameter<Float> THROWER_Y = EntityDataManager.<Float>createKey(EntityJu87.class,
			DataSerializers.FLOAT);
	public static final DataParameter<Float> THROWER_Z = EntityDataManager.<Float>createKey(EntityJu87.class,
			DataSerializers.FLOAT);
	public static final DataParameter<Float> YAW = EntityDataManager.<Float>createKey(EntityJu87.class,
			DataSerializers.FLOAT);
	public static final DataParameter<ItemStack> STACK = EntityDataManager.<ItemStack>createKey(EntityJu87.class,
			DataSerializers.ITEM_STACK);

	public EntityJu87(World worldIn) {
		super(worldIn, "kansaiki");
	}

	public EntityJu87(World worldIn, EntityLivingBase thrower, ItemStack stack) {
	...
	/* エンティティに与えるダメージ 素材から値を代入して計算する方法
	@Override
	protected float getImpactDamage(Entity target) {
	...
	public MaterialDefinition getMaterialDefinition() {
		...
		try {
			md = ((ItemJu87) getItemStack().getItem()).getMaterialDefinition();
	...
	public void setItemStack(ItemStack stack) {
		if (stack == null || stack.isEmpty() || !(stack.getItem() instanceof ItemJu87)) {
