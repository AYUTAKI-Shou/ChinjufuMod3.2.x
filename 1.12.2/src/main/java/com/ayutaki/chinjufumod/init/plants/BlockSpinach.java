...
public class BlockSpinach extends BlockCrops {
	...
	public BlockSpinach(String unlocalizedName) {
	...
	protected Item getSeed() {
		return TTimeItems.SEEDS_SPINACH;

	}

	@Override
	protected Item getCrop() {
		return ChinjufuModItemFoods.FOOD_SPINACH;
