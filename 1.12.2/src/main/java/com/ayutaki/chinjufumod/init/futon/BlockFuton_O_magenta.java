...
public class BlockFuton_O_magenta extends BlockFuton_magenta {
	...
	public BlockFuton_O_magenta(Material material, String unlocalizedName) {
		super(material);
	...
	public boolean onBlockActivated(World worldIn, BlockPos pos, IBlockState state, EntityPlayer playerIn,
		...
		if (playerIn.isSneaking()) {
				...
				return worldIn.setBlockState(pos, ASDecoModTatami.FUTON_C_magenta.getDefaultState()
