...
public class BlockBoxD_Carrot extends BlockBox_Carrot {
	...
	public BlockBoxD_Carrot(String unlocalizedName) {
	...
	public List<ItemStack> getDrops(IBlockAccess world, BlockPos pos, IBlockState state, int fortune) {
		List<ItemStack> stack = new ArrayList<ItemStack>();
	        ...
	        stack.add(new ItemStack(Items.CARROT, 16, this.damageDropped(state)));
	        return stack;
	...
	public ItemStack getPickBlock(IBlockState state, RayTraceResult target, World world,
		...
		return new ItemStack(ASDecoModPantry.BOX_H_CARROT);
	}
