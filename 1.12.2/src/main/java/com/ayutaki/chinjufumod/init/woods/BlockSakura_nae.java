...
import com.ayutaki.chinjufumod.init.woods.treegen.WorldGenTreeSakuraBig;
...
public class BlockSakura_nae extends BlockBush implements IGrowable {

	/* 成長の段階を持たせる */
	public static final PropertyInteger STAGE = PropertyInteger.create("stage", 0, 1);

	public BlockSakura_nae() {
	...
	public void generateTree(World worldIn, BlockPos pos, IBlockState state, Random rand) {
		...
		WorldGenerator worldgenerator =
				(WorldGenerator)(rand.nextInt(40) == 0 ? new WorldGenTreeSakuraBig(true) : new WorldGenTreeSakura(true));
