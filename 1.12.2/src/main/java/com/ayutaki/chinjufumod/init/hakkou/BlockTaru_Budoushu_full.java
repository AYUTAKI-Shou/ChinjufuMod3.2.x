...
public class BlockTaru_Budoushu_full extends BlockRotatedPillar {
	...
	public void updateTick(World world, BlockPos pos, IBlockState state, Random random) {
		...
		if (true) {
			...
			world.setBlockState(pos,ASDecoModHakkou.BUDOUSHUTARU_1.getDefaultState().withProperty(AXIS, state.getValue(AXIS)));
		}
	...
	public void addInformation(ItemStack stack, @Nullable World playerIn, List<String> tooltip, ITooltipFlag advanced) {
		...
		tooltip.add(I18n.format("tips.tile.block_taru_budoushu.name", meta));
	}
