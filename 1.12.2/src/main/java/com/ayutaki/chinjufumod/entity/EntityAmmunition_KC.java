...
public class EntityAmmunition_KC extends EntityArrow implements IProjectile {
	...
	public void onHit(RayTraceResult raytraceResultIn) {
		...
		if (true) {
			...
			CMExplosion explosion = new CMExplosion(world, this, this.posX, this.posY, this.posZ, 2.4F, false, CMConfigCore_new.blastBlockBreak);
		...
		/* 効果音の上書き */
		if (entity != null) {
			this.playSound(SoundsHandler.AM_IMPACT, 2.0F, 0.8F);
		}
		else {
			this.playSound(SoundsHandler.AM_IMPACT, 2.0F, 0.8F);
		}
