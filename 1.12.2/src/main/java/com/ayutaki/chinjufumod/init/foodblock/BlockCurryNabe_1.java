...
public class BlockCurryNabe_1 extends BlockFacingSapo {
	...
	public boolean onBlockActivated(World worldIn, BlockPos pos, IBlockState state, EntityPlayer playerIn,
		...
		if (item != Item.getItemFromBlock(ChinjufuModFoodBlocks.RICE_1)) {
			return true;
		}

		else if (item == Item.getItemFromBlock(ChinjufuModFoodBlocks.RICE_1)) {
			...
			if (itemstack.isEmpty()) {
				...
				.addItemStackToInventory(new ItemStack(Item.getItemFromBlock(ChinjufuModFoodBlocks.CURRY_1)));

			}
			else if (!playerIn.inventory.addItemStackToInventory(new ItemStack(Item.getItemFromBlock(ChinjufuModFoodBlocks.CURRY_1)))) {
				playerIn.dropItem(new ItemStack(Item.getItemFromBlock(ChinjufuModFoodBlocks.CURRY_1)), false);
			}

			return worldIn.setBlockState(pos, ChinjufuModFoodBlocks.CURRYNABE_2
	...
	public void addInformation(ItemStack stack, @Nullable World playerIn, List<String> tooltip, ITooltipFlag advanced) {
		...
		tooltip.add(I18n.format("tips.tile.block_food_cunabe_1.name", meta));
	}
