...
public class ASDecoModNamako {
	...
	public static Block NAMAKO_black, NAMAKO_blue, NAMAKO_brown, NAMAKO_cyan,
						NAMAKO_gray, NAMAKO_green, NAMAKO_lightb, NAMAKO_lightg,
						NAMAKO_lime, NAMAKO_magenta, NAMAKO_orange, NAMAKO_pink,
						NAMAKO_purple, NAMAKO_red, NAMAKO_yellow, NAMAKO_white;

	public static Block NAMAKO_ST_black, NAMAKO_ST_blue, NAMAKO_ST_brown, NAMAKO_ST_cyan,
						NAMAKO_ST_gray, NAMAKO_ST_green, NAMAKO_ST_lightb, NAMAKO_ST_lightg,
						NAMAKO_ST_lime, NAMAKO_ST_magenta, NAMAKO_ST_orange, NAMAKO_ST_pink,
						NAMAKO_ST_purple, NAMAKO_ST_red, NAMAKO_ST_yellow, NAMAKO_ST_white;
	...
	public static Block NAMAKOB_black, NAMAKOB_blue, NAMAKOB_brown, NAMAKOB_cyan,
						NAMAKOB_gray, NAMAKOB_green, NAMAKOB_lightb, NAMAKOB_lightg,
						NAMAKOB_lime, NAMAKOB_magenta, NAMAKOB_orange, NAMAKOB_pink,
						NAMAKOB_purple, NAMAKOB_red, NAMAKOB_yellow, NAMAKOB_white;

	public static Block NAMAKOB_ST_black, NAMAKOB_ST_blue, NAMAKOB_ST_brown, NAMAKOB_ST_cyan,
						NAMAKOB_ST_gray, NAMAKOB_ST_green, NAMAKOB_ST_lightb, NAMAKOB_ST_lightg,
						NAMAKOB_ST_lime, NAMAKOB_ST_magenta, NAMAKOB_ST_orange, NAMAKOB_ST_pink,
						NAMAKOB_ST_purple, NAMAKOB_ST_red, NAMAKOB_ST_yellow, NAMAKOB_ST_white;
	...
	public static void init() {
		...
		DUMMYNAMAKO = new BlockDummyNamako().setRegistryName("dummy_namako").setUnlocalizedName("dummy_namako");

		NAMAKO_black = new BlockNamako_c(Material.WOOD, "block_namako_black");
		NAMAKO_blue = new BlockNamako_c(Material.WOOD, "block_namako_blue");
		NAMAKO_brown = new BlockNamako_c(Material.WOOD, "block_namako_brown");
		NAMAKO_cyan = new BlockNamako_c(Material.WOOD, "block_namako_cyan");
		NAMAKO_gray = new BlockNamako_c(Material.WOOD, "block_namako_gray");
		NAMAKO_green = new BlockNamako_c(Material.WOOD, "block_namako_green");
		NAMAKO_lightb = new BlockNamako_c(Material.WOOD, "block_namako_lightb");
		NAMAKO_lightg = new BlockNamako_c(Material.WOOD, "block_namako_lightg");
		NAMAKO_lime = new BlockNamako_c(Material.WOOD, "block_namako_lime");
		NAMAKO_magenta = new BlockNamako_c(Material.WOOD, "block_namako_magenta");
		NAMAKO_orange = new BlockNamako_c(Material.WOOD, "block_namako_orange");
		NAMAKO_pink = new BlockNamako_c(Material.WOOD, "block_namako_pink");
		NAMAKO_purple = new BlockNamako_c(Material.WOOD, "block_namako_purple");
		NAMAKO_red = new BlockNamako_c(Material.WOOD, "block_namako_red");
		NAMAKO_yellow = new BlockNamako_c(Material.WOOD, "block_namako_yellow");
		NAMAKO_white = new BlockNamako_c(Material.WOOD, "block_namako_white");

		NAMAKO_ST_black = new BlockNamakoStairs_c("block_nst_black", DUMMYNAMAKO.getDefaultState());
		NAMAKO_ST_blue = new BlockNamakoStairs_c("block_nst_blue", DUMMYNAMAKO.getDefaultState());
		NAMAKO_ST_brown = new BlockNamakoStairs_c("block_nst_brown", DUMMYNAMAKO.getDefaultState());
		NAMAKO_ST_cyan = new BlockNamakoStairs_c("block_nst_cyan", DUMMYNAMAKO.getDefaultState());
		NAMAKO_ST_gray = new BlockNamakoStairs_c("block_nst_gray", DUMMYNAMAKO.getDefaultState());
		NAMAKO_ST_green = new BlockNamakoStairs_c("block_nst_green", DUMMYNAMAKO.getDefaultState());
		NAMAKO_ST_lightb = new BlockNamakoStairs_c("block_nst_lightb", DUMMYNAMAKO.getDefaultState());
		NAMAKO_ST_lightg = new BlockNamakoStairs_c("block_nst_lightg", DUMMYNAMAKO.getDefaultState());
		NAMAKO_ST_lime = new BlockNamakoStairs_c("block_nst_lime", DUMMYNAMAKO.getDefaultState());
		NAMAKO_ST_magenta = new BlockNamakoStairs_c("block_nst_magenta", DUMMYNAMAKO.getDefaultState());
		NAMAKO_ST_orange = new BlockNamakoStairs_c("block_nst_orange", DUMMYNAMAKO.getDefaultState());
		NAMAKO_ST_pink = new BlockNamakoStairs_c("block_nst_pink", DUMMYNAMAKO.getDefaultState());
		NAMAKO_ST_purple = new BlockNamakoStairs_c("block_nst_purple", DUMMYNAMAKO.getDefaultState());
		NAMAKO_ST_red = new BlockNamakoStairs_c("block_nst_red", DUMMYNAMAKO.getDefaultState());
		NAMAKO_ST_yellow = new BlockNamakoStairs_c("block_nst_yellow", DUMMYNAMAKO.getDefaultState());
		NAMAKO_ST_white = new BlockNamakoStairs_c("block_nst_white", DUMMYNAMAKO.getDefaultState());
		...
		NAMAKOB_black = new BlockNamako_c(Material.WOOD, "block_namako_b_black");
		NAMAKOB_blue = new BlockNamako_c(Material.WOOD, "block_namako_b_blue");
		NAMAKOB_brown = new BlockNamako_c(Material.WOOD, "block_namako_b_brown");
		NAMAKOB_cyan = new BlockNamako_c(Material.WOOD, "block_namako_b_cyan");
		NAMAKOB_gray = new BlockNamako_c(Material.WOOD, "block_namako_b_gray");
		NAMAKOB_green = new BlockNamako_c(Material.WOOD, "block_namako_b_green");
		NAMAKOB_lightb = new BlockNamako_c(Material.WOOD, "block_namako_b_lightb");
		NAMAKOB_lightg = new BlockNamako_c(Material.WOOD, "block_namako_b_lightg");
		NAMAKOB_lime = new BlockNamako_c(Material.WOOD, "block_namako_b_lime");
		NAMAKOB_magenta = new BlockNamako_c(Material.WOOD, "block_namako_b_magenta");
		NAMAKOB_orange = new BlockNamako_c(Material.WOOD, "block_namako_b_orange");
		NAMAKOB_pink = new BlockNamako_c(Material.WOOD, "block_namako_b_pink");
		NAMAKOB_purple = new BlockNamako_c(Material.WOOD, "block_namako_b_purple");
		NAMAKOB_red = new BlockNamako_c(Material.WOOD, "block_namako_b_red");
		NAMAKOB_yellow = new BlockNamako_c(Material.WOOD, "block_namako_b_yellow");
		NAMAKOB_white = new BlockNamako_c(Material.WOOD, "block_namako_b_white");

		NAMAKOB_ST_black = new BlockNamakoStairs_c("block_nst_b_black", DUMMYNAMAKO.getDefaultState());
		NAMAKOB_ST_blue = new BlockNamakoStairs_c("block_nst_b_blue", DUMMYNAMAKO.getDefaultState());
		NAMAKOB_ST_brown = new BlockNamakoStairs_c("block_nst_b_brown", DUMMYNAMAKO.getDefaultState());
		NAMAKOB_ST_cyan = new BlockNamakoStairs_c("block_nst_b_cyan", DUMMYNAMAKO.getDefaultState());
		NAMAKOB_ST_gray = new BlockNamakoStairs_c("block_nst_b_gray", DUMMYNAMAKO.getDefaultState());
		NAMAKOB_ST_green = new BlockNamakoStairs_c("block_nst_b_green", DUMMYNAMAKO.getDefaultState());
		NAMAKOB_ST_lightb = new BlockNamakoStairs_c("block_nst_b_lightb", DUMMYNAMAKO.getDefaultState());
		NAMAKOB_ST_lightg = new BlockNamakoStairs_c("block_nst_b_lightg", DUMMYNAMAKO.getDefaultState());
		NAMAKOB_ST_lime = new BlockNamakoStairs_c("block_nst_b_lime", DUMMYNAMAKO.getDefaultState());
		NAMAKOB_ST_magenta = new BlockNamakoStairs_c("block_nst_b_magenta", DUMMYNAMAKO.getDefaultState());
		NAMAKOB_ST_orange = new BlockNamakoStairs_c("block_nst_b_orange", DUMMYNAMAKO.getDefaultState());
		NAMAKOB_ST_pink = new BlockNamakoStairs_c("block_nst_b_pink", DUMMYNAMAKO.getDefaultState());
		NAMAKOB_ST_purple = new BlockNamakoStairs_c("block_nst_b_purple", DUMMYNAMAKO.getDefaultState());
		NAMAKOB_ST_red = new BlockNamakoStairs_c("block_nst_b_red", DUMMYNAMAKO.getDefaultState());
		NAMAKOB_ST_yellow = new BlockNamakoStairs_c("block_nst_b_yellow", DUMMYNAMAKO.getDefaultState());
		NAMAKOB_ST_white = new BlockNamakoStairs_c("block_nst_b_white", DUMMYNAMAKO.getDefaultState());
