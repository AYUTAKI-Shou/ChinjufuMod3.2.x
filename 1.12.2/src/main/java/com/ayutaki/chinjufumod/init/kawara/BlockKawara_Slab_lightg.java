...
public abstract class BlockKawara_Slab_lightg extends BlockSlab {

	public static final PropertyInteger CRA = PropertyInteger.create("cra", 1, 2);

	public BlockKawara_Slab_lightg(String unlocalizedName) {
		super(Material.WOOD);
	...
	public Item getItemDropped(IBlockState state, Random rand, int fortune) {
		return Item.getItemFromBlock(ASDecoModKawara.KAWARA_SH_lightg);
	}
