...
public class BlockCiderJuku_Gla_1 extends Block {

	public BlockCiderJuku_Gla_1() {
		super(Material.WOOD);
	...
	public boolean onBlockActivated(World worldIn, BlockPos pos, IBlockState state, EntityPlayer playerIn, EnumHand hand, EnumFacing facing,
		...
		if (!itemstack.isEmpty()) {
			...
			return worldIn.setBlockState(pos, ASDecoModHakkou.JUKUCIDERGLA_2.getDefaultState());
		}
    	return true;
	}
