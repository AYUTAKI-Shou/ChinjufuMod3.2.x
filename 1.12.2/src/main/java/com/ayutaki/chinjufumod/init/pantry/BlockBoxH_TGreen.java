...
public class BlockBoxH_TGreen extends BlockBox_TGreen {

	public BlockBoxH_TGreen(String unlocalizedName) {
	...
	public List<ItemStack> getDrops(IBlockAccess world, BlockPos pos, IBlockState state, int fortune) {
		List<ItemStack> stack = new ArrayList<ItemStack>();
	        ...
	        stack.add(new ItemStack(ASDecoModPantry.CHADUTSU, 8, this.damageDropped(state)));
	        return stack;
