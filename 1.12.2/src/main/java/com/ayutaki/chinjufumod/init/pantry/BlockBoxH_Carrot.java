...
public class BlockBoxH_Carrot extends BlockBox_Carrot {

	public BlockBoxH_Carrot(String unlocalizedName) {
	...
	public List<ItemStack> getDrops(IBlockAccess world, BlockPos pos, IBlockState state, int fortune) {
		List<ItemStack> stack = new ArrayList<ItemStack>();
	        ...
	        stack.add(new ItemStack(Items.CARROT, 8, this.damageDropped(state)));
	        return stack;
