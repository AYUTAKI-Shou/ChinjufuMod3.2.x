...
import com.ayutaki.chinjufumod.init.items.armor.model.ModelRJBody;
...
public class ItemRyujouArmor_kai extends ItemArmor {
	...
	public ItemRyujouArmor_kai(int renderIndexIn, EntityEquipmentSlot equipmentSlotIn) {
		super(ChinjufuModArmorMaterial.RJ, renderIndexIn, equipmentSlotIn);
	}
	...
	public void onArmorTick(World world, EntityPlayer player, ItemStack armor) {
		...
		if(this != ChinjufuModArmor.RJ_BOOTS_KAI) {}
