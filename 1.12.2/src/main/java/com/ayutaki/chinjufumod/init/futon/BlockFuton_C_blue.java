...
public class BlockFuton_C_blue extends BlockFuton_blue {
	...
	public BlockFuton_C_blue(Material material, String unlocalizedName) {
		super(material);
	...
	public boolean onBlockActivated(World worldIn, BlockPos pos, IBlockState state, EntityPlayer playerIn,
		...
		if (playerIn.isSneaking()) {
				...
				return worldIn.setBlockState(pos, ASDecoModTatami.FUTON_O_blue.getDefaultState()
