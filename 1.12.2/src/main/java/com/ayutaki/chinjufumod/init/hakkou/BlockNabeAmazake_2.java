...
public class BlockNabeAmazake_2 extends BlockFacingSapo {
		...
		if (item != TTimeItems.Item_YUNOMI) {
			...
			if (itemstack.isEmpty()) {
				((EntityPlayer) playerIn).inventory
						.addItemStackToInventory(new ItemStack(Item.getItemFromBlock(ASDecoModHakkou.AMAZAKEGLA_1)));
			}
			...
			return worldIn.setBlockState(pos, ASDecoModHakkou.NABEAMAZAKE_3
