...
public class BlockNoren_orange extends BlockFacingSapo {
	...
	public BlockNoren_orange(Material material, String unlocalizedName) {
		super(material);
	...
	public IBlockState getActualState(IBlockState state, IBlockAccess worldIn, BlockPos pos) {
			...
			boolean left = left_block.getBlock() instanceof BlockNoren_orange && left_block.getValue(FACING).equals(facing);
			boolean right = right_block.getBlock() instanceof BlockNoren_orange && right_block.getValue(FACING).equals(facing);
