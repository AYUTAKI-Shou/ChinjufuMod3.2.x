...
public class BlockEggburg_2 extends BlockFacingSapo {
	...
	public boolean onBlockActivated(World worldIn, BlockPos pos, IBlockState state, EntityPlayer playerIn,
		...
		if (!itemstack.isEmpty()) {
			...
			return worldIn.setBlockState(pos, ChinjufuModFoodBlocks.EGGBURG_kara.getDefaultState()
