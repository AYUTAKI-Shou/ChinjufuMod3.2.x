...
public class BlockBoxH_Potato extends BlockBox_Potato {

	public BlockBoxH_Potato(String unlocalizedName) {
	...
	public List<ItemStack> getDrops(IBlockAccess world, BlockPos pos, IBlockState state, int fortune) {
		List<ItemStack> stack = new ArrayList<ItemStack>();
	        ...
	        stack.add(new ItemStack(Items.POTATO, 8, this.damageDropped(state)));
	        return stack;
