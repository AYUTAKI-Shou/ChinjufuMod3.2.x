...
public class BlockBin_Nyusan_full extends BlockFacingSapo {
	...
	public void updateTick(World world, BlockPos pos, IBlockState state, Random random) {
		...
		if (true) {
			world.setBlockState(pos,ASDecoModHakkou.NYUSANBIN_1.getDefaultState().withProperty(FACING, state.getValue(FACING)));
		}
	...
	public void addInformation(ItemStack stack, @Nullable World playerIn, List<String> tooltip, ITooltipFlag advanced) {
		...
		tooltip.add(I18n.format("tips.tile.block_bin_nyusan.name", meta));
	}
