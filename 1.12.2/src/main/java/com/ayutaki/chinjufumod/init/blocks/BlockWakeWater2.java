...
public class BlockWakeWater2 extends Block {

	public BlockWakeWater2() {
	...
	public void updateTick(World world, BlockPos pos, IBlockState state, Random random) {
		...
		if (true) {
			world.setBlockState(pos, ChinjufuModBlocks.WAKE_WATER3.getDefaultState());
		}
	...
	public void randomDisplayTick(IBlockState state, World world, BlockPos pos, Random random) {
		...
		if (random.nextDouble() < 0.1D) {
			...
			world.playSound(i, j, k, SoundsHandler.WATER_WAKE, SoundCategory.BLOCKS, 1.0F, 1.0F, false);
		}
	}
