...
public class BlockBoxH_Mutton extends BlockBox_Mutton {

	public BlockBoxH_Mutton(String unlocalizedName) {
	...
	public List<ItemStack> getDrops(IBlockAccess world, BlockPos pos, IBlockState state, int fortune) {
		List<ItemStack> stack = new ArrayList<ItemStack>();
	        ...
	        stack.add(new ItemStack(Items.MUTTON, 8, this.damageDropped(state)));
	        return stack;
