...
public class BlockKawara_c extends Block {

	public static final PropertyInteger CRA = PropertyInteger.create("cra", 1, 2);

	public BlockKawara_c(Material material, String unlocalizedName) {
	...
	public void addInformation(ItemStack stack, @Nullable World playerIn, List<String> tooltip, ITooltipFlag advanced) {
		...
		tooltip.add(I18n.format("tips.tile.block_kawara.name", meta));
	}
}
