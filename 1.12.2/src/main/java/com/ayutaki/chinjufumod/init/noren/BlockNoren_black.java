...
public class BlockNoren_black extends BlockFacingSapo {
	...
	public BlockNoren_black(Material material, String unlocalizedName) {
		super(material);
	...
	public IBlockState getActualState(IBlockState state, IBlockAccess worldIn, BlockPos pos) {
			...
			boolean left = left_block.getBlock() instanceof BlockNoren_black && left_block.getValue(FACING).equals(facing);
			boolean right = right_block.getBlock() instanceof BlockNoren_black && right_block.getValue(FACING).equals(facing);
