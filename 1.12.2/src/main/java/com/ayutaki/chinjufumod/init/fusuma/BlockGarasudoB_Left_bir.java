...
public abstract class BlockGarasudoB_Left_bir extends BlockFacingSapo {

	public abstract boolean isOpen();

	public BlockGarasudoB_Left_bir(Material material) {
		super(material);
	...
	public boolean onBlockActivated(World worldIn, BlockPos pos, IBlockState state, EntityPlayer playerIn,
		...
		if (playerIn.isSneaking()) {
			...
			worldIn.playSound(null, pos, SoundsHandler.HIKIDO, SoundCategory.BLOCKS, 1.0F, 1.0F);
			return worldIn.setBlockState(pos, ASDecoModFusuma.GARASUDOB_OL_bir.getDefaultState().withProperty(FACING, state.getValue(FACING)));
		}
	}
