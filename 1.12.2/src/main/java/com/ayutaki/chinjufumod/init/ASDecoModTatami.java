...
import com.ayutaki.chinjufumod.init.tatami.BlockTatamiD_Y;
import com.ayutaki.chinjufumod.init.tatami.BlockTatamiD_Y_black;
import com.ayutaki.chinjufumod.init.tatami.BlockTatamiD_Y_blue;
import com.ayutaki.chinjufumod.init.tatami.BlockTatamiD_Y_brown;
import com.ayutaki.chinjufumod.init.tatami.BlockTatamiD_Y_cyan;
import com.ayutaki.chinjufumod.init.tatami.BlockTatamiD_Y_gray;
import com.ayutaki.chinjufumod.init.tatami.BlockTatamiD_Y_green;
import com.ayutaki.chinjufumod.init.tatami.BlockTatamiD_Y_lightb;
import com.ayutaki.chinjufumod.init.tatami.BlockTatamiD_Y_lightg;
import com.ayutaki.chinjufumod.init.tatami.BlockTatamiD_Y_lime;
import com.ayutaki.chinjufumod.init.tatami.BlockTatamiD_Y_magenta;
import com.ayutaki.chinjufumod.init.tatami.BlockTatamiD_Y_orange;
import com.ayutaki.chinjufumod.init.tatami.BlockTatamiD_Y_pink;
import com.ayutaki.chinjufumod.init.tatami.BlockTatamiD_Y_purple;
import com.ayutaki.chinjufumod.init.tatami.BlockTatamiD_Y_red;
import com.ayutaki.chinjufumod.init.tatami.BlockTatamiD_Y_white;
import com.ayutaki.chinjufumod.init.tatami.BlockTatamiD_Y_yellow;
...
import com.ayutaki.chinjufumod.init.tatami.BlockTatami_Slab;
import com.ayutaki.chinjufumod.init.tatami.BlockTatami_Y_Slab;
...
public class ASDecoModTatami {
	...
	public static Block TATAMI_H, TATAMI_H_black, TATAMI_H_blue, TATAMI_H_brown, TATAMI_H_cyan,
	TATAMI_H_gray, TATAMI_H_green, TATAMI_H_lightb, TATAMI_H_lightg,
	TATAMI_H_lime, TATAMI_H_magenta, TATAMI_H_orange, TATAMI_H_pink,
	TATAMI_H_purple, TATAMI_H_red, TATAMI_H_yellow, TATAMI_H_white;

public static Block TATAMI_Y_H, TATAMI_Y_H_black, TATAMI_Y_H_blue, TATAMI_Y_H_brown, TATAMI_Y_H_cyan,
	TATAMI_Y_H_gray, TATAMI_Y_H_green, TATAMI_Y_H_lightb, TATAMI_Y_H_lightg,
	TATAMI_Y_H_lime, TATAMI_Y_H_magenta, TATAMI_Y_H_orange, TATAMI_Y_H_pink,
	TATAMI_Y_H_purple, TATAMI_Y_H_red, TATAMI_Y_H_yellow, TATAMI_Y_H_white;

public static Block TATAMI_D, TATAMI_D_black, TATAMI_D_blue, TATAMI_D_brown, TATAMI_D_cyan,
	TATAMI_D_gray, TATAMI_D_green, TATAMI_D_lightb, TATAMI_D_lightg,
	TATAMI_D_lime, TATAMI_D_magenta, TATAMI_D_orange, TATAMI_D_pink,
	TATAMI_D_purple, TATAMI_D_red, TATAMI_D_yellow, TATAMI_D_white;

public static Block TATAMI_Y_D, TATAMI_Y_D_black, TATAMI_Y_D_blue, TATAMI_Y_D_brown, TATAMI_Y_D_cyan,
	TATAMI_Y_D_gray, TATAMI_Y_D_green, TATAMI_Y_D_lightb, TATAMI_Y_D_lightg,
	TATAMI_Y_D_lime, TATAMI_Y_D_magenta, TATAMI_Y_D_orange, TATAMI_Y_D_pink,
	TATAMI_Y_D_purple, TATAMI_Y_D_red, TATAMI_Y_D_yellow, TATAMI_Y_D_white;
	...
	public static void init() {
		TATAMI_H = new BlockTatami_Slab("block_tatamih");
		TATAMI_H_black = new BlockTatami_Slab("block_tatamih_black");
		TATAMI_H_blue = new BlockTatami_Slab("block_tatamih_blue");
		TATAMI_H_brown = new BlockTatami_Slab("block_tatamih_brown");
		TATAMI_H_cyan = new BlockTatami_Slab("block_tatamih_cyan");
		TATAMI_H_gray = new BlockTatami_Slab("block_tatamih_gray");
		TATAMI_H_green = new BlockTatami_Slab("block_tatamih_green");
		TATAMI_H_lightb = new BlockTatami_Slab("block_tatamih_lightb");
		TATAMI_H_lightg = new BlockTatami_Slab("block_tatamih_lightg");
		TATAMI_H_lime = new BlockTatami_Slab("block_tatamih_lime");
		TATAMI_H_magenta = new BlockTatami_Slab("block_tatamih_magenta");
		TATAMI_H_orange = new BlockTatami_Slab("block_tatamih_orange");
		TATAMI_H_pink = new BlockTatami_Slab("block_tatamih_pink");
		TATAMI_H_purple = new BlockTatami_Slab("block_tatamih_purple");
		TATAMI_H_red = new BlockTatami_Slab("block_tatamih_red");
		TATAMI_H_white = new BlockTatami_Slab("block_tatamih_white");
		TATAMI_H_yellow = new BlockTatami_Slab("block_tatamih_yellow");
		...
		TATAMI_Y_H = new BlockTatami_Y_Slab("block_tatamih_y");
		TATAMI_Y_H_black = new BlockTatami_Y_Slab("block_tatamih_y_black");
		TATAMI_Y_H_blue = new BlockTatami_Y_Slab("block_tatamih_y_blue");
		TATAMI_Y_H_brown = new BlockTatami_Y_Slab("block_tatamih_y_brown");
		TATAMI_Y_H_cyan = new BlockTatami_Y_Slab("block_tatamih_y_cyan");
		TATAMI_Y_H_gray = new BlockTatami_Y_Slab("block_tatamih_y_gray");
		TATAMI_Y_H_green = new BlockTatami_Y_Slab("block_tatamih_y_green");
		TATAMI_Y_H_lightb = new BlockTatami_Y_Slab("block_tatamih_y_lightb");
		TATAMI_Y_H_lightg = new BlockTatami_Y_Slab("block_tatamih_y_lightg");
		TATAMI_Y_H_lime = new BlockTatami_Y_Slab("block_tatamih_y_lime");
		TATAMI_Y_H_magenta = new BlockTatami_Y_Slab("block_tatamih_y_magenta");
		TATAMI_Y_H_orange = new BlockTatami_Y_Slab("block_tatamih_y_orange");
		TATAMI_Y_H_pink = new BlockTatami_Y_Slab("block_tatamih_y_pink");
		TATAMI_Y_H_purple = new BlockTatami_Y_Slab("block_tatamih_y_purple");
		TATAMI_Y_H_red = new BlockTatami_Y_Slab("block_tatamih_y_red");
		TATAMI_Y_H_white = new BlockTatami_Y_Slab("block_tatamih_y_white");
		TATAMI_Y_H_yellow = new BlockTatami_Y_Slab("block_tatamih_y_yellow");

		TATAMI_Y_D = new BlockTatamiD_Y("block_tatamid_y");
		TATAMI_Y_D_black = new BlockTatamiD_Y_black("block_tatamid_y_black");
		TATAMI_Y_D_blue = new BlockTatamiD_Y_blue("block_tatamid_y_blue");
		TATAMI_Y_D_brown = new BlockTatamiD_Y_brown("block_tatamid_y_brown");
		TATAMI_Y_D_cyan = new BlockTatamiD_Y_cyan("block_tatamid_y_cyan");
		TATAMI_Y_D_gray = new BlockTatamiD_Y_gray("block_tatamid_y_gray");
		TATAMI_Y_D_green = new BlockTatamiD_Y_green("block_tatamid_y_green");
		TATAMI_Y_D_lightb = new BlockTatamiD_Y_lightb("block_tatamid_y_lightb");
		TATAMI_Y_D_lightg = new BlockTatamiD_Y_lightg("block_tatamid_y_lightg");
		TATAMI_Y_D_lime = new BlockTatamiD_Y_lime("block_tatamid_y_lime");
		TATAMI_Y_D_magenta = new BlockTatamiD_Y_magenta("block_tatamid_y_magenta");
		TATAMI_Y_D_orange = new BlockTatamiD_Y_orange("block_tatamid_y_orange");
		TATAMI_Y_D_pink = new BlockTatamiD_Y_pink("block_tatamid_y_pink");
		TATAMI_Y_D_purple = new BlockTatamiD_Y_purple("block_tatamid_y_purple");
		TATAMI_Y_D_red = new BlockTatamiD_Y_red("block_tatamid_y_red");
		TATAMI_Y_D_white = new BlockTatamiD_Y_white("block_tatamid_y_white");
		TATAMI_Y_D_yellow = new BlockTatamiD_Y_yellow("block_tatamid_y_yellow");
	...
	public static void register() {
		...
		registerBlock(TATAMI_D);
		registerBlock(TATAMI_D_black);
		registerBlock(TATAMI_D_blue);
		registerBlock(TATAMI_D_brown);
		registerBlock(TATAMI_D_cyan);
		registerBlock(TATAMI_D_gray);
		registerBlock(TATAMI_D_green);
		registerBlock(TATAMI_D_lightb);
		registerBlock(TATAMI_D_lightg);
		registerBlock(TATAMI_D_lime);
		registerBlock(TATAMI_D_magenta);
		registerBlock(TATAMI_D_orange);
		registerBlock(TATAMI_D_pink);
		registerBlock(TATAMI_D_purple);
		registerBlock(TATAMI_D_red);
		registerBlock(TATAMI_D_yellow);
		registerBlock(TATAMI_D_white);

		registerBlock(TATAMI_Y_H);
		registerBlock(TATAMI_Y_H_black);
		registerBlock(TATAMI_Y_H_blue);
		registerBlock(TATAMI_Y_H_brown);
		registerBlock(TATAMI_Y_H_cyan);
		registerBlock(TATAMI_Y_H_gray);
		registerBlock(TATAMI_Y_H_green);
		registerBlock(TATAMI_Y_H_lightb);
		registerBlock(TATAMI_Y_H_lightg);
		registerBlock(TATAMI_Y_H_lime);
		registerBlock(TATAMI_Y_H_magenta);
		registerBlock(TATAMI_Y_H_orange);
		registerBlock(TATAMI_Y_H_pink);
		registerBlock(TATAMI_Y_H_purple);
		registerBlock(TATAMI_Y_H_red);
		registerBlock(TATAMI_Y_H_yellow);
		registerBlock(TATAMI_Y_H_white);
		registerBlock(TATAMI_Y_D);
		registerBlock(TATAMI_Y_D_black);
		registerBlock(TATAMI_Y_D_blue);
		registerBlock(TATAMI_Y_D_brown);
		registerBlock(TATAMI_Y_D_cyan);
		registerBlock(TATAMI_Y_D_gray);
		registerBlock(TATAMI_Y_D_green);
		registerBlock(TATAMI_Y_D_lightb);
		registerBlock(TATAMI_Y_D_lightg);
		registerBlock(TATAMI_Y_D_lime);
		registerBlock(TATAMI_Y_D_magenta);
		registerBlock(TATAMI_Y_D_orange);
		registerBlock(TATAMI_Y_D_pink);
		registerBlock(TATAMI_Y_D_purple);
		registerBlock(TATAMI_Y_D_red);
		registerBlock(TATAMI_Y_D_yellow);
		registerBlock(TATAMI_Y_D_white);
	...
	public static void registerRenders() {
		...
		registerRender(TATAMI_D);
		registerRender(TATAMI_D_black);
		registerRender(TATAMI_D_blue);
		registerRender(TATAMI_D_brown);
		registerRender(TATAMI_D_cyan);
		registerRender(TATAMI_D_gray);
		registerRender(TATAMI_D_green);
		registerRender(TATAMI_D_lightb);
		registerRender(TATAMI_D_lightg);
		registerRender(TATAMI_D_lime);
		registerRender(TATAMI_D_magenta);
		registerRender(TATAMI_D_orange);
		registerRender(TATAMI_D_pink);
		registerRender(TATAMI_D_purple);
		registerRender(TATAMI_D_red);
		registerRender(TATAMI_D_yellow);
		registerRender(TATAMI_D_white);

		registerRender(TATAMI_Y_H);
		registerRender(TATAMI_Y_H_black);
		registerRender(TATAMI_Y_H_blue);
		registerRender(TATAMI_Y_H_brown);
		registerRender(TATAMI_Y_H_cyan);
		registerRender(TATAMI_Y_H_gray);
		registerRender(TATAMI_Y_H_green);
		registerRender(TATAMI_Y_H_lightb);
		registerRender(TATAMI_Y_H_lightg);
		registerRender(TATAMI_Y_H_lime);
		registerRender(TATAMI_Y_H_magenta);
		registerRender(TATAMI_Y_H_orange);
		registerRender(TATAMI_Y_H_pink);
		registerRender(TATAMI_Y_H_purple);
		registerRender(TATAMI_Y_H_red);
		registerRender(TATAMI_Y_H_yellow);
		registerRender(TATAMI_Y_H_white);
		registerRender(TATAMI_Y_D);
		registerRender(TATAMI_Y_D_black);
		registerRender(TATAMI_Y_D_blue);
		registerRender(TATAMI_Y_D_brown);
		registerRender(TATAMI_Y_D_cyan);
		registerRender(TATAMI_Y_D_gray);
		registerRender(TATAMI_Y_D_green);
		registerRender(TATAMI_Y_D_lightb);
		registerRender(TATAMI_Y_D_lightg);
		registerRender(TATAMI_Y_D_lime);
		registerRender(TATAMI_Y_D_magenta);
		registerRender(TATAMI_Y_D_orange);
		registerRender(TATAMI_Y_D_pink);
		registerRender(TATAMI_Y_D_purple);
		registerRender(TATAMI_Y_D_red);
		registerRender(TATAMI_Y_D_yellow);
		registerRender(TATAMI_Y_D_white);
