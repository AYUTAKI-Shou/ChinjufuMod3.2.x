...
public abstract class BlockBGC_new_Slab extends BlockSlab {

	public BlockBGC_new_Slab(String unlocalizedName) {
		super(Material.ROCK);
	...
	public Item getItemDropped(IBlockState state, Random rand, int fortune) {
		return Item.getItemFromBlock(ASDecoModWallPane.BGC_SlabHalf);
	}
