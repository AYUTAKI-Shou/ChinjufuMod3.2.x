...
public class BlockNoren_gray extends BlockFacingSapo {
	...
	public BlockNoren_gray(Material material, String unlocalizedName) {
		super(material);
	...
	public IBlockState getActualState(IBlockState state, IBlockAccess worldIn, BlockPos pos) {
			...
			boolean left = left_block.getBlock() instanceof BlockNoren_gray && left_block.getValue(FACING).equals(facing);
			boolean right = right_block.getBlock() instanceof BlockNoren_gray && right_block.getValue(FACING).equals(facing);
