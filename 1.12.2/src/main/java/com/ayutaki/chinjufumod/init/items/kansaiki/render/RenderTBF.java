...
public class RenderTBF extends TBFRender<EntityTBF> {

	public RenderTBF(RenderManager renderManager) {
		super(renderManager, new ModelTBF(), 90);
	}

	public static final ResourceLocation RESOURCE =
			new ResourceLocation(Reference.MOD_ID, "textures/entity/projectiles/tbf.png");

	@Override
	protected ResourceLocation getEntityTexture(EntityTBF entity) {
			return RESOURCE;
	}

	@Override
	public void renderEntityModel(EntityTBF theEntity, double x, double y, double z, float yaw,
			float partialTick) {
		GL11.glPushMatrix();
