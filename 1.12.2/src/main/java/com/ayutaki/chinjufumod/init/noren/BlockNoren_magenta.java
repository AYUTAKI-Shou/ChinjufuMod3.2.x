...
public class BlockNoren_magenta extends BlockFacingSapo {
	...
	public BlockNoren_magenta(Material material, String unlocalizedName) {
		super(material);
	...
	public IBlockState getActualState(IBlockState state, IBlockAccess worldIn, BlockPos pos) {
			...
			boolean left = left_block.getBlock() instanceof BlockNoren_magenta && left_block.getValue(FACING).equals(facing);
			boolean right = right_block.getBlock() instanceof BlockNoren_magenta && right_block.getValue(FACING).equals(facing);
