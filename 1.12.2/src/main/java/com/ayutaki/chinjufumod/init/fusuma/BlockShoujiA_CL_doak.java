...
public class BlockShoujiA_CL_doak extends BlockShoujiA_Left_doak {
	...
	public BlockShoujiA_CL_doak(Material material, String unlocalizedName) {
		super(material);
	...
	public void addInformation(ItemStack stack, @Nullable World playerIn, List<String> tooltip, ITooltipFlag advanced) {
		...
		tooltip.add(I18n.format("tips.tile.block_shouji.name", meta));
	}
}
