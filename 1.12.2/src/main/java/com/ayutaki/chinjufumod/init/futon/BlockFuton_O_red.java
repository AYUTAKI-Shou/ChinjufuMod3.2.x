...
public class BlockFuton_O_red extends BlockFuton_red {
	...
	public BlockFuton_O_red(Material material, String unlocalizedName) {
		super(material);
	...
	public boolean onBlockActivated(World worldIn, BlockPos pos, IBlockState state, EntityPlayer playerIn,
		...
		if (playerIn.isSneaking()) {
				...
				return worldIn.setBlockState(pos, ASDecoModTatami.FUTON_C_red.getDefaultState()
