...
public class BlockNoren_cyan extends BlockFacingSapo {
	...
	public BlockNoren_cyan(Material material, String unlocalizedName) {
		super(material);
	...
	public IBlockState getActualState(IBlockState state, IBlockAccess worldIn, BlockPos pos) {
			...
			boolean left = left_block.getBlock() instanceof BlockNoren_cyan && left_block.getValue(FACING).equals(facing);
			boolean right = right_block.getBlock() instanceof BlockNoren_cyan && right_block.getValue(FACING).equals(facing);
