...
public class BlockNoren_yellow extends BlockFacingSapo {
	...
	public BlockNoren_yellow(Material material, String unlocalizedName) {
		super(material);
	...
	public IBlockState getActualState(IBlockState state, IBlockAccess worldIn, BlockPos pos) {
			...
			boolean left = left_block.getBlock() instanceof BlockNoren_yellow && left_block.getValue(FACING).equals(facing);
			boolean right = right_block.getBlock() instanceof BlockNoren_yellow && right_block.getValue(FACING).equals(facing);
