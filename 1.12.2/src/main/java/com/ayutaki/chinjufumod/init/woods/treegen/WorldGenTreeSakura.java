...
public class WorldGenTreeSakura extends WorldGenAbstractTree {

	private IBlockState blockStateWood = ASDecoModWoods.SAKURA_log.getDefaultState();
	private IBlockState blockStateLeaves =
			ASDecoModWoods.SAKURA_flow.getDefaultState().withProperty(BlockLeaves.CHECK_DECAY, Boolean.valueOf(false));

	/* 生成される木の高さの最小値 デフォルト4 */
	private final int minTreeHeight = 4;

	public WorldGenTreeSakura(boolean parShouldNotify) {
