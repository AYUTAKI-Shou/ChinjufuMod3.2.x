...
public class BlockGarasudoB_CL_spru extends BlockGarasudoB_Left_spru {
	...
	public BlockGarasudoB_CL_spru(Material material, String unlocalizedName) {
		super(material);
	...
	public void addInformation(ItemStack stack, @Nullable World playerIn, List<String> tooltip, ITooltipFlag advanced) {
		...
		tooltip.add(I18n.format("tips.tile.block_garasudo.name", meta));
	}
}
