...
public class BlockNoren_lightg extends BlockFacingSapo {
	...
	public BlockNoren_lightg(Material material, String unlocalizedName) {
		super(material);
	...
	public IBlockState getActualState(IBlockState state, IBlockAccess worldIn, BlockPos pos) {
			...
			boolean left = left_block.getBlock() instanceof BlockNoren_lightg && left_block.getValue(FACING).equals(facing);
			boolean right = right_block.getBlock() instanceof BlockNoren_lightg && right_block.getValue(FACING).equals(facing);
