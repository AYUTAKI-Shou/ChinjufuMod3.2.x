...
public class ItemYkt_Inaduma extends ItemArmor {
	...
	public ItemYkt_Inaduma(int renderIndexIn, EntityEquipmentSlot equipmentSlotIn) {
		super(ChinjufuModArmorMaterial.INADUMAYKT, renderIndexIn, equipmentSlotIn);
	...
	public void addInformation(ItemStack stack, @Nullable World playerIn, List<String> tooltip, ITooltipFlag advanced) {
		...
		if(this == ChinjufuModArmor.INADUMAYKT_HELMET) { }

		if(this == ChinjufuModArmor.INADUMAYKT_CHESTPLATE) {
			tooltip.add(I18n.format("tips.item.item_ykt.name", meta));
		}

		if(this == ChinjufuModArmor.INADUMAYKT_LEGGINGS) {
			tooltip.add(I18n.format("tips.item.item_ykt.name", meta));
		}
	}
