...
public class BlockTaru_Kouji_1 extends Block {

	public BlockTaru_Kouji_1() {
		super(Material.WOOD);
	...
	public boolean onBlockActivated(World worldIn, BlockPos pos, IBlockState state, EntityPlayer playerIn, EnumHand hand, EnumFacing facing,
		...
		if (!itemstack.isEmpty()) {
			return true;
				...
				((EntityPlayer) playerIn).inventory.addItemStackToInventory(new ItemStack(TTimeItems.KOMEKOUJI, 4));
