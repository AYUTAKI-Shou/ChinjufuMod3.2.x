...
public class BlockBoxH_Cabbage extends BlockBox_Cabbage {

	public BlockBoxH_Cabbage(String unlocalizedName) {
	...
	public List<ItemStack> getDrops(IBlockAccess world, BlockPos pos, IBlockState state, int fortune) {
		List<ItemStack> stack = new ArrayList<ItemStack>();
	        ...
	        stack.add(new ItemStack(ChinjufuModItemFoods.FOOD_CABBAGE, 4, this.damageDropped(state)));
	        return stack;
