...
public class BlockKakigouriRed_2 extends BlockFacingSapo {
	...
	public boolean onBlockActivated(World worldIn, BlockPos pos, IBlockState state, EntityPlayer playerIn,
		...
		if (!itemstack.isEmpty()) {
			...
			/* 1秒＝20 かき氷は ×30=600 */
			((EntityLivingBase) playerIn).addPotionEffect(new PotionEffect(MobEffects.NIGHT_VISION, 750, 0));

			worldIn.playSound(null, pos, SoundsHandler.PAKU, SoundCategory.PLAYERS, 1.0F, 1.0F);
			return worldIn.setBlockState(pos, ChinjufuModSeasons.KAKIGOURI_red3.getDefaultState()
