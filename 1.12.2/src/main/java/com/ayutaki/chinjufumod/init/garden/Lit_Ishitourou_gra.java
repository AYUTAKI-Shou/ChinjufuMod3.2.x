...
public class Lit_Ishitourou_gra extends Block {

	public Lit_Ishitourou_gra() {
		super(Material.WOOD);
	...
	public boolean onBlockActivated(World worldIn, BlockPos pos, IBlockState state, EntityPlayer playerIn,
		...
		if (itemstack.isEmpty()) {
			...
			return worldIn.setBlockState(pos, ASDecoModGarden.ISHITOUROU_gra.getDefaultState());
		}
		return true;
	}
	...
	public List<ItemStack> getDrops(IBlockAccess world, BlockPos pos, IBlockState state, int fortune) {
		List<ItemStack> stack = new ArrayList<ItemStack>();
			...
			stack.add(new ItemStack(ASDecoModGarden.ISHITOUROU_gra, 1, this.damageDropped(state)));
	...
	public ItemStack getPickBlock(IBlockState state, RayTraceResult target, World world, BlockPos pos, EntityPlayer player) {
		return new ItemStack(ASDecoModGarden.ISHITOUROU_gra);
	}
}
