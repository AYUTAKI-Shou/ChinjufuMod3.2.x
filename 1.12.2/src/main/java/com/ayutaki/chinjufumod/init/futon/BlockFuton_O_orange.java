...
public class BlockFuton_O_orange extends BlockFuton_orange {
	...
	public BlockFuton_O_orange(Material material, String unlocalizedName) {
		super(material);
	...
	public boolean onBlockActivated(World worldIn, BlockPos pos, IBlockState state, EntityPlayer playerIn,
		...
		if (playerIn.isSneaking()) {
				...
				return worldIn.setBlockState(pos, ASDecoModTatami.FUTON_C_orange.getDefaultState()
