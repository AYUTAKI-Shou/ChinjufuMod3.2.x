...
public class BlockTeaPot_4 extends BlockFacingSapo {
	...
	public boolean onBlockActivated(World worldIn, BlockPos pos, IBlockState state, EntityPlayer playerIn,
		...
		if (item != TTimeItems.Item_TCUP) {
			...
			if (itemstack.isEmpty()) {
				...
				.addItemStackToInventory(new ItemStack(Item.getItemFromBlock(ChinjufuModFoodBlocks.TEACUP_1)));
			...
			return worldIn.setBlockState(pos, ChinjufuModFoodBlocks.TEAPOT_kara
