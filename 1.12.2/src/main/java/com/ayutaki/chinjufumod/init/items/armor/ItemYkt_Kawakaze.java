...
public class ItemYkt_Kawakaze extends ItemArmor {
	...
	public ItemYkt_Kawakaze(int renderIndexIn, EntityEquipmentSlot equipmentSlotIn) {
		super(ChinjufuModArmorMaterial.KAWAKAZEYKT, renderIndexIn, equipmentSlotIn);
	...
	public void addInformation(ItemStack stack, @Nullable World playerIn, List<String> tooltip, ITooltipFlag advanced) {
		...
		if(this == ChinjufuModArmor.KAWAKAZEYKT_HELMET) { }

		if(this == ChinjufuModArmor.KAWAKAZEYKT_CHESTPLATE) {
			tooltip.add(I18n.format("tips.item.item_ykt.name", meta));
		}

		if(this == ChinjufuModArmor.KAWAKAZEYKT_LEGGINGS) {
			tooltip.add(I18n.format("tips.item.item_ykt.name", meta));
		}
	}
