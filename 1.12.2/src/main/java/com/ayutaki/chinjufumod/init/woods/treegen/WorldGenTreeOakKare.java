...
public class WorldGenTreeOakKare extends WorldGenAbstractTree {
	...
	private IBlockState blockStateLeaves =
			ASDecoModWoods.OAKKARE_leaf.getDefaultState().withProperty(BlockLeaves.CHECK_DECAY, Boolean.valueOf(false));

	/* 生成される木の高さの最小値 デフォルト4 */
	private final int minTreeHeight = 4;

	public WorldGenTreeOakKare(boolean parShouldNotify) {
