...
public class BlockNoren_lime extends BlockFacingSapo {
	...
	public BlockNoren_lime(Material material, String unlocalizedName) {
		super(material);
	...
	public IBlockState getActualState(IBlockState state, IBlockAccess worldIn, BlockPos pos) {
			...
			boolean left = left_block.getBlock() instanceof BlockNoren_lime && left_block.getValue(FACING).equals(facing);
			boolean right = right_block.getBlock() instanceof BlockNoren_lime && right_block.getValue(FACING).equals(facing);
