...
public class BlockFuton_C_lightg extends BlockFuton_lightg {
	...
	public BlockFuton_C_lightg(Material material, String unlocalizedName) {
		super(material);
	...
	public boolean onBlockActivated(World worldIn, BlockPos pos, IBlockState state, EntityPlayer playerIn,
		...
		if (playerIn.isSneaking()) {
				...
				return worldIn.setBlockState(pos, ASDecoModTatami.FUTON_O_lightg.getDefaultState()
