...
public class BlockBoxH_Cherry extends BlockBox_Cherry {

	public BlockBoxH_Cherry(String unlocalizedName) {
	...
	public List<ItemStack> getDrops(IBlockAccess world, BlockPos pos, IBlockState state, int fortune) {
		List<ItemStack> stack = new ArrayList<ItemStack>();
	        ...
	        stack.add(new ItemStack(ChinjufuModItemFoods.FOOD_CHERRY, 8, this.damageDropped(state)));
	        return stack;
