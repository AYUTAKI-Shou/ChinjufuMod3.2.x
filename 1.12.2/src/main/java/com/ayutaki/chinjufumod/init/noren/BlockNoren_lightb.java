...
public class BlockNoren_lightb extends BlockFacingSapo {
	...
	public BlockNoren_lightb(Material material, String unlocalizedName) {
		super(material);
	...
	public IBlockState getActualState(IBlockState state, IBlockAccess worldIn, BlockPos pos) {
			...
			boolean left = left_block.getBlock() instanceof BlockNoren_lightb && left_block.getValue(FACING).equals(facing);
			boolean right = right_block.getBlock() instanceof BlockNoren_lightb && right_block.getValue(FACING).equals(facing);
