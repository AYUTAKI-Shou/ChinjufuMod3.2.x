...
public class BlockBoxH_Grape extends BlockBox_Grape {

	public BlockBoxH_Grape(String unlocalizedName) {
	...
	public List<ItemStack> getDrops(IBlockAccess world, BlockPos pos, IBlockState state, int fortune) {
		List<ItemStack> stack = new ArrayList<ItemStack>();
	        ...
	        stack.add(new ItemStack(ChinjufuModItemFoods.FOOD_GRAPE, 8, this.damageDropped(state)));
	        return stack;
