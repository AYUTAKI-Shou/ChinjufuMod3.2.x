...
public class ModelSwordfish extends ModelBase {
	...
	public ModelSwordfish() {
		super();
			...
			/*翼*/
	    	tile1 = new ModelRenderer(this, 0, 2);
	    	tile1.addBox( 0.0F, 1.1F, 18.0F, 16, 0, 2);
	    	tile1.setRotationPoint(0.0F, 0.0F, 0.0F);
	    	tile1.mirror = false;
	    	setRotateAngle(tile1, 0F, 0F, 0F);
	    	/*機体*/
	    	tile2 = new ModelRenderer(this, 0, 4);
	    	tile2.addBox( 7.5F, 1.0F, 16.5F, 1, 1, 11);
	    	...
	    	tile4.addBox( 5.0F, 2.0F, 25.5F, 6, 0, 3);
			...
			/*翼2*/
	    	tile6 = new ModelRenderer(this, 0, 0);
	    	tile6.addBox( 0.0F, 2.5F, 18.0F, 16, 0, 2);
