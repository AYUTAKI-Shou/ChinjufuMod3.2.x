...
public class WorldGenCM implements IWorldGenerator {
	...
	public void generate(Random random, int chunkX, int chunkZ,
		...
		/*ifを追加*/
		if (CMConfigCore_new.isGeneratorEnabled && world.provider instanceof WorldProviderSurface) {

			switch (world.provider.getDimension()) {

			case 0: //オーバーワールド Coal=142,Iron=77,RedStone=25,Gold=8,Lapiz=3.4
				this.runGenerator(bauxite_cm, world, random, chunkX, chunkZ, CMConfigCore_new.isGeneratorChance, 10, 70);
				break;
