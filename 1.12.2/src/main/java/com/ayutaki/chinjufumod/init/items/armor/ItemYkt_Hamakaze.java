...
public class ItemYkt_Hamakaze extends ItemArmor {
	...
	public ItemYkt_Hamakaze(int renderIndexIn, EntityEquipmentSlot equipmentSlotIn) {
		super(ChinjufuModArmorMaterial.HAMAKAZEYKT, renderIndexIn, equipmentSlotIn);
	...
	public void addInformation(ItemStack stack, @Nullable World playerIn, List<String> tooltip, ITooltipFlag advanced) {
		...
		if(this == ChinjufuModArmor.HAMAKAZEYKT_HELMET) { }

		if(this == ChinjufuModArmor.HAMAKAZEYKT_CHESTPLATE) {
			tooltip.add(I18n.format("tips.item.item_ykt.name", meta));
		}

		if(this == ChinjufuModArmor.HAMAKAZEYKT_LEGGINGS) {
			tooltip.add(I18n.format("tips.item.item_ykt.name", meta));
		}
	}
