...
public class WorldGenTreeIchoh extends WorldGenAbstractTree {

	private IBlockState blockStateWood = ASDecoModWoods.ICHOH_log.getDefaultState();
	private IBlockState blockStateLeaves =
			ASDecoModWoods.ICHOH_leaf.getDefaultState().withProperty(BlockLeaves.CHECK_DECAY, Boolean.valueOf(false));

	/*生成される木の高さの最小値 デフォルト4 → 5*/
	private final int minTreeHeight = 5;

	public WorldGenTreeIchoh(boolean parShouldNotify) {
