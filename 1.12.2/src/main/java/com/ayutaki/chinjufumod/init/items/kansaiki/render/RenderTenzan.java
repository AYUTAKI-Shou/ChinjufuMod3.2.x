...
public class RenderTenzan extends TenzanRender<EntityTenzan> {

	public RenderTenzan(RenderManager renderManager) {
		super(renderManager, new ModelTenzan(), 90);
	}

	public static final ResourceLocation RESOURCE =
			new ResourceLocation(Reference.MOD_ID, "textures/entity/projectiles/tenzan.png");

	@Override
	protected ResourceLocation getEntityTexture(EntityTenzan entity) {
			return RESOURCE;
	}

	@Override
	public void renderEntityModel(EntityTenzan theEntity, double x, double y, double z, float yaw,
			float partialTick) {
		GL11.glPushMatrix();
