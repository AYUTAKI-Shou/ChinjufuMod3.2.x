...
public class EntityTBF extends KansaikiThrowable {

	public static final DataParameter<Float> THROWER_X = EntityDataManager.<Float>createKey(EntityTBF.class,
			DataSerializers.FLOAT);
	public static final DataParameter<Float> THROWER_Y = EntityDataManager.<Float>createKey(EntityTBF.class,
			DataSerializers.FLOAT);
	public static final DataParameter<Float> THROWER_Z = EntityDataManager.<Float>createKey(EntityTBF.class,
			DataSerializers.FLOAT);
	public static final DataParameter<Float> YAW = EntityDataManager.<Float>createKey(EntityTBF.class,
			DataSerializers.FLOAT);
	public static final DataParameter<ItemStack> STACK = EntityDataManager.<ItemStack>createKey(EntityTBF.class,
			DataSerializers.ITEM_STACK);

	public EntityTBF(World worldIn) {
		super(worldIn, "kansaiki");
	}

	public EntityTBF(World worldIn, EntityLivingBase thrower, ItemStack stack) {
	...
	public MaterialDefinition getMaterialDefinition() {
		...
		try {
			md = ((ItemTBF) getItemStack().getItem()).getMaterialDefinition();
	...
	public void setItemStack(ItemStack stack) {
		if (stack == null || stack.isEmpty() || !(stack.getItem() instanceof ItemTBF)) {
