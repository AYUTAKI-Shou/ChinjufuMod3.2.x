...
public class BlockSakeShin_Gla_2 extends Block {

	public BlockSakeShin_Gla_2() {
		super(Material.WOOD);
	...
	public boolean onBlockActivated(World worldIn, BlockPos pos, IBlockState state, EntityPlayer playerIn, EnumHand hand, EnumFacing facing,
		...
		if (!itemstack.isEmpty()) {
			...
			return worldIn.setBlockState(pos, ASDecoModHakkou.NAMASAKEGLA_kara.getDefaultState());
		}
    	return true;
	}
