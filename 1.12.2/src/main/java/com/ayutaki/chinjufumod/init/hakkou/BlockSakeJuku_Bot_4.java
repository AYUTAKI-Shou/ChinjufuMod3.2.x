...
public class BlockSakeJuku_Bot_4 extends BlockFacingSapo {

	public BlockSakeJuku_Bot_4() {
		super(Material.WOOD);
		...
		if (item != TTimeItems.Item_DRINKGLASS) {
			...
			if (itemstack.isEmpty()) {
				((EntityPlayer) playerIn).inventory
						.addItemStackToInventory(new ItemStack(Item.getItemFromBlock(ASDecoModHakkou.JUKUSAKEGLA_1)));
			}
			...
			return worldIn.setBlockState(pos, ASDecoModHakkou.JUKUSAKEBOT_kara
