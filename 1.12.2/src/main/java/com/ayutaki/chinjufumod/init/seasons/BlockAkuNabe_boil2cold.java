...
public class BlockAkuNabe_boil2cold extends BlockFacingSapo {
	...
	public void updateTick(World world, BlockPos pos, IBlockState state, Random random) {
		...
		if (world.getBlockState(new BlockPos(i, j - 1, k)).getBlock() == Blocks.LIT_FURNACE || world
			...
			world.setBlockState(pos,ChinjufuModSeasons.AKUNABE_boil
	...
	public boolean onBlockActivated(World worldIn, BlockPos pos, IBlockState state, EntityPlayer playerIn,
		...
		if (item != Item.getItemFromBlock(ChinjufuModSeasons2.KUSATABA)) {
			...
			return  worldIn.setBlockState(pos, ChinjufuModSeasons.ORIITONABE_full2cold
					.getDefaultState().withProperty(FACING, state.getValue(FACING)));
		}
		return true;
	}
	...
	public void addInformation(ItemStack stack, @Nullable World playerIn, List<String> tooltip, ITooltipFlag advanced) {
		...
		tooltip.add(I18n.format("tips.tile.block_nabeaku_bc.name", meta));
	}
