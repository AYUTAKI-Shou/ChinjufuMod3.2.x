...
public class BlockSconeSet_3 extends BlockFacingSapo {

	public BlockSconeSet_3()  {
		super(Material.WOOD);
	...
	public boolean onBlockActivated(World worldIn, BlockPos pos, IBlockState state, EntityPlayer playerIn,
		...
		if (itemstack.isEmpty()) {
			...
			return worldIn.setBlockState(pos, ChinjufuModFoodBlocks.SCONESET_4.getDefaultState()
