...
public class BlockIshitourou_gra extends Block {

	public BlockIshitourou_gra() {
		super(Material.WOOD);
	...
	public boolean onBlockActivated(World worldIn, BlockPos pos, IBlockState state, EntityPlayer playerIn,
		...
		if (item == Items.FLINT_AND_STEEL) {
			...
			return worldIn.setBlockState(pos, ASDecoModGarden.LIT_ISHITOUROU_gra.getDefaultState());
		}
		return true;
	}
