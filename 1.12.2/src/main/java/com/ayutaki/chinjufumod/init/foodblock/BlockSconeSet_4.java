...
public class BlockSconeSet_4 extends BlockFacingSapo {

	public BlockSconeSet_4()  {
		super(Material.WOOD);
	...
	public boolean onBlockActivated(World worldIn, BlockPos pos, IBlockState state, EntityPlayer playerIn,
		...
		if (itemstack.isEmpty()) {
			...
			return worldIn.setBlockState(pos, ChinjufuModFoodBlocks.SCONESET_a.getDefaultState()
