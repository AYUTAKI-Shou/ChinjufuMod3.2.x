...
public class BlockZundou_coldmilk_2 extends BlockFacingSapo {
	...
	public boolean onBlockActivated(World worldIn, BlockPos pos, IBlockState state, EntityPlayer playerIn,
		...
		if (item != TTimeItems.RENNET) {
			return true;
		}

		else if (item == TTimeItems.RENNET) {

		   	itemstack.shrink(1);
			worldIn.playSound(null, pos, SoundsHandler.WATER_SPLASH, SoundCategory.BLOCKS, 0.5F, 1.2F);

			return worldIn.setBlockState(pos, ASDecoModHakkou.NABE_coldmilk_3
