...
public class BlockOriitoNabe_boil2cold extends BlockFacingSapo {
	...
	public BlockOriitoNabe_boil2cold()  {
		super(Material.WOOD);
	...
	public void updateTick(World world, BlockPos pos, IBlockState state, Random random) {
		...
		if (world.getBlockState(new BlockPos(i, j - 1, k)).getBlock() == Blocks.LIT_FURNACE || world
			...
			world.setBlockState(pos, ChinjufuModSeasons.ORIITONABE_boil
	...
	public boolean onBlockActivated(World worldIn, BlockPos pos, IBlockState state, EntityPlayer playerIn,
		...
		if (!itemstack.isEmpty()) {
			...
			((EntityPlayer) playerIn).inventory.addItemStackToInventory(new ItemStack(ChinjufuModItems.ORIITO, 8));

			worldIn.playSound(null, pos, SoundEvents.ENTITY_ITEM_PICKUP, SoundCategory.PLAYERS, 0.2F, 2.0F);
			return worldIn.setBlockState(pos, ChinjufuModSeasons.AKUNABE_boil2cold
					.getDefaultState().withProperty(FACING, state.getValue(FACING)));
		}
		return true;
	}
