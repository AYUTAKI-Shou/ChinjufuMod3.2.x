...
public class EntitySwordfish extends KansaikiThrowable {

	public static final DataParameter<Float> THROWER_X = EntityDataManager.<Float>createKey(EntitySwordfish.class,
			DataSerializers.FLOAT);
	public static final DataParameter<Float> THROWER_Y = EntityDataManager.<Float>createKey(EntitySwordfish.class,
			DataSerializers.FLOAT);
	public static final DataParameter<Float> THROWER_Z = EntityDataManager.<Float>createKey(EntitySwordfish.class,
			DataSerializers.FLOAT);
	public static final DataParameter<Float> YAW = EntityDataManager.<Float>createKey(EntitySwordfish.class,
			DataSerializers.FLOAT);
	public static final DataParameter<ItemStack> STACK = EntityDataManager.<ItemStack>createKey(EntitySwordfish.class,
			DataSerializers.ITEM_STACK);

	public EntitySwordfish(World worldIn) {
		super(worldIn, "kansaiki");
	}

	public EntitySwordfish(World worldIn, EntityLivingBase thrower, ItemStack stack) {
	...
	public MaterialDefinition getMaterialDefinition() {
		...
		try {
			md = ((ItemSwordfish) getItemStack().getItem()).getMaterialDefinition();
	...
	public void setItemStack(ItemStack stack) {
		if (stack == null || stack.isEmpty() || !(stack.getItem() instanceof ItemSwordfish)) {
