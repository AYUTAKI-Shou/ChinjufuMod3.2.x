...
public class BlockNoren_white extends BlockFacingSapo {
	...
	public BlockNoren_white(Material material, String unlocalizedName) {
		super(material);
	...
	public IBlockState getActualState(IBlockState state, IBlockAccess worldIn, BlockPos pos) {
			...
			boolean left = left_block.getBlock() instanceof BlockNoren_white && left_block.getValue(FACING).equals(facing);
			boolean right = right_block.getBlock() instanceof BlockNoren_white && right_block.getValue(FACING).equals(facing);
