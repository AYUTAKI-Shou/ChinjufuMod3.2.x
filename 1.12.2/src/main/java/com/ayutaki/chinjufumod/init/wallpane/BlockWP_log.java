...
public class BlockWP_log extends BlockFacingSapo {
	...
	public static final PropertyInteger LOG = PropertyInteger.create("log", 1, 3);

	public BlockWP_log(Material material) {
		...
		setDefaultState(this.blockState.getBaseState()
				...
				.withProperty(LOG, Integer.valueOf(1)));
	}
	...
	protected BlockStateContainer createBlockState() {
		return new BlockStateContainer(this, new IProperty[] { FACING, LOG });
	}
