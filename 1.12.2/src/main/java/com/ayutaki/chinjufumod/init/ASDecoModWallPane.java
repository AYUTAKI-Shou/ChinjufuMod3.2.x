...
import com.ayutaki.chinjufumod.init.wallpane.BlockRock_AND_SlabDouble;
import com.ayutaki.chinjufumod.init.wallpane.BlockRock_AND_SlabHalf;
import com.ayutaki.chinjufumod.init.wallpane.BlockRock_DIO_SlabDouble;
import com.ayutaki.chinjufumod.init.wallpane.BlockRock_DIO_SlabHalf;
import com.ayutaki.chinjufumod.init.wallpane.BlockRock_GRA_SlabDouble;
import com.ayutaki.chinjufumod.init.wallpane.BlockRock_GRA_SlabHalf;
import com.ayutaki.chinjufumod.init.wallpane.BlockRockStairs_and;
import com.ayutaki.chinjufumod.init.wallpane.BlockRockStairs_dio;
import com.ayutaki.chinjufumod.init.wallpane.BlockRockStairs_gra;
...
public class ASDecoModWallPane {

	public static Block ROCKSTAIRS_AND;
	public static Block ROCKSTAIRS_DIO;
	public static Block ROCKSTAIRS_GRA;

	public static BlockRock_AND_SlabHalf RAND_SlabHalf;
	public static BlockRock_AND_SlabDouble RAND_SlabDouble;
	public static BlockRock_DIO_SlabHalf RDIO_SlabHalf;
	public static BlockRock_DIO_SlabDouble RDIO_SlabDouble;
	public static BlockRock_GRA_SlabHalf RGRA_SlabHalf;
	public static BlockRock_GRA_SlabDouble RGRA_SlabDouble;
	...
	public static void init() {
		...
		ROCKSTAIRS_AND = new BlockRockStairs_and("block_rockstairs_and", Blocks.STONE.getDefaultState()).setRegistryName("block_rockstairs_and").setUnlocalizedName("block_rockstairs_and").setCreativeTab(ChinjufuModTabs.tab_wallpanel);
		ROCKSTAIRS_DIO = new BlockRockStairs_dio("block_rockstairs_dio", Blocks.STONE.getDefaultState()).setRegistryName("block_rockstairs_dio").setUnlocalizedName("block_rockstairs_dio").setCreativeTab(ChinjufuModTabs.tab_wallpanel);
		ROCKSTAIRS_GRA = new BlockRockStairs_gra("block_rockstairs_gra", Blocks.STONE.getDefaultState()).setRegistryName("block_rockstairs_gra").setUnlocalizedName("block_rockstairs_gra").setCreativeTab(ChinjufuModTabs.tab_wallpanel);

		RAND_SlabHalf = new BlockRock_AND_SlabHalf("block_rand_slabhalf");
		RAND_SlabDouble = new BlockRock_AND_SlabDouble("block_rand_slabdouble");
		RDIO_SlabHalf = new BlockRock_DIO_SlabHalf("block_rdio_slabhalf");
		RDIO_SlabDouble = new BlockRock_DIO_SlabDouble("block_rdio_slabdouble");
		RGRA_SlabHalf = new BlockRock_GRA_SlabHalf("block_rgra_slabhalf");
		RGRA_SlabDouble = new BlockRock_GRA_SlabDouble("block_rgra_slabdouble");
	...
	public static void register() {
		...
		registerBlock(ROCKSTAIRS_AND);
		registerBlock(ROCKSTAIRS_DIO);
		registerBlock(ROCKSTAIRS_GRA);

		registerBlock(RAND_SlabHalf, new ItemSlab(RAND_SlabHalf, RAND_SlabHalf, RAND_SlabDouble));
		registerBlock(RAND_SlabDouble);
		registerBlock(RDIO_SlabHalf, new ItemSlab(RDIO_SlabHalf, RDIO_SlabHalf, RDIO_SlabDouble));
		registerBlock(RDIO_SlabDouble);
		registerBlock(RGRA_SlabHalf, new ItemSlab(RGRA_SlabHalf, RGRA_SlabHalf, RGRA_SlabDouble));
		registerBlock(RGRA_SlabDouble);
	...
	public static void registerRenders() {
		...
		registerRender(ROCKSTAIRS_AND);
		registerRender(ROCKSTAIRS_DIO);
		registerRender(ROCKSTAIRS_GRA);
	...
	public static class RegistrationHandler {
		...
		public static void registerItems(final RegistryEvent.Register<Block> event) {
			...
			ASDecoModWallPane.init();
			ASDecoModWallPane.register();
