...
public class BlockOriitoNabe_full2cold extends BlockFacingSapo {
	...
	public BlockOriitoNabe_full2cold()  {
		super(Material.WOOD);
	...
	public void updateTick(World world, BlockPos pos, IBlockState state, Random random) {
		...
		if (world.getBlockState(new BlockPos(i, j - 1, k)).getBlock() == Blocks.LIT_FURNACE || world
			...
			world.setBlockState(pos, ChinjufuModSeasons.ORIITONABE_full
