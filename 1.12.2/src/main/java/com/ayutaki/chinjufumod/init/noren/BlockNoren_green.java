...
public class BlockNoren_green extends BlockFacingSapo {
	...
	public BlockNoren_green(Material material, String unlocalizedName) {
		super(material);
	...
	public IBlockState getActualState(IBlockState state, IBlockAccess worldIn, BlockPos pos) {
			...
			boolean left = left_block.getBlock() instanceof BlockNoren_green && left_block.getValue(FACING).equals(facing);
			boolean right = right_block.getBlock() instanceof BlockNoren_green && right_block.getValue(FACING).equals(facing);
