...
public class BlockFuton_C_yellow extends BlockFuton_yellow {
	...
	public BlockFuton_C_yellow(Material material, String unlocalizedName) {
		super(material);
	...
	public boolean onBlockActivated(World worldIn, BlockPos pos, IBlockState state, EntityPlayer playerIn,
		...
		if (playerIn.isSneaking()) {
				...
				return worldIn.setBlockState(pos, ASDecoModTatami.FUTON_O_yellow.getDefaultState()
