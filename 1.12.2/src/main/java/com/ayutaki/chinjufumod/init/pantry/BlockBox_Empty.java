...
public abstract class BlockBox_Empty extends BlockSlab {

	public BlockBox_Empty(String unlocalizedName) {
	...
	public Item getItemDropped(IBlockState state, Random rand, int fortune) {
		return Item.getItemFromBlock(ASDecoModPantry.BOX_H_EMPTY);
	}
