...
public class BlockCStove_new_lit extends BlockFacingSapo {
	...
	public void updateTick(World world, BlockPos pos, IBlockState state, Random random) {
		...
		if (true) {
			...
			world.setBlockState(pos,ChinjufuModSchool.CSTOVE.getDefaultState().withProperty(FACING, state.getValue(FACING)));
		}
