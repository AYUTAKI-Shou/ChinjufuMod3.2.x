...
public abstract class BlockSakura_Slab extends BlockSlab {

	public BlockSakura_Slab(String unlocalizedName) {
		super(Material.WOOD);
	...
	public Item getItemDropped(IBlockState state, Random rand, int fortune) {
		return Item.getItemFromBlock(ASDecoModWoods.SAKURA_SlabHalf);
	}
