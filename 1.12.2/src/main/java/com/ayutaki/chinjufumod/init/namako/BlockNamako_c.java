...
public class BlockNamako_c extends Block {

	public static final PropertyInteger CRA = PropertyInteger.create("cra", 1, 2);

	public BlockNamako_c(Material material, String unlocalizedName) {
		...
		setDefaultState(this.blockState.getBaseState()
				.withProperty(CRA, Integer.valueOf(1)));
	...
	public void addInformation(ItemStack stack, @Nullable World playerIn, List<String> tooltip, ITooltipFlag advanced) {
		...
		tooltip.add(I18n.format("tips.tile.block_namako.name", meta));
	}
}
