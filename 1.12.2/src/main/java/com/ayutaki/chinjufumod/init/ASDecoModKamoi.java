...
public class ASDecoModKamoi {
	...
	public static Block KAMOI_dirt_oak, KAMOI_dirt_aca, KAMOI_dirt_bir, KAMOI_dirt_doak, KAMOI_dirt_jun, KAMOI_dirt_spru;
	...
	public static void init() {
		...
		KAMOI_dirt_oak = new BlockKamoi_dirt(Material.WOOD, "block_ka_dirt_oak").setCreativeTab(ChinjufuModTabs.tab_cmodwablock);
		KAMOI_dirt_aca = new BlockKamoi_dirt(Material.WOOD, "block_ka_dirt_aca").setCreativeTab(ChinjufuModTabs.tab_cmodwablock);
		KAMOI_dirt_bir = new BlockKamoi_dirt(Material.WOOD, "block_ka_dirt_bir").setCreativeTab(ChinjufuModTabs.tab_cmodwablock);
		KAMOI_dirt_doak = new BlockKamoi_dirt(Material.WOOD, "block_ka_dirt_doak").setCreativeTab(ChinjufuModTabs.tab_cmodwablock);
		KAMOI_dirt_jun = new BlockKamoi_dirt(Material.WOOD, "block_ka_dirt_jun").setCreativeTab(ChinjufuModTabs.tab_cmodwablock);
		KAMOI_dirt_spru = new BlockKamoi_dirt(Material.WOOD, "block_ka_dirt_spru").setCreativeTab(ChinjufuModTabs.tab_cmodwablock);
	...
	public static void registerRenders() {
		...
		registerRender(KAMOI_dirt_oak);
		registerRender(KAMOI_dirt_aca);
		registerRender(KAMOI_dirt_bir);
		registerRender(KAMOI_dirt_doak);
		registerRender(KAMOI_dirt_jun);
		registerRender(KAMOI_dirt_spru);
