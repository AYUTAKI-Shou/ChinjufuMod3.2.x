...
public class BlockChouzuGra_3 extends Block {

	public BlockChouzuGra_3() {
		super(Material.WOOD);
	...
	public boolean onBlockActivated(World worldIn, BlockPos pos, IBlockState state, EntityPlayer playerIn,
		...
		if (itemstack.isEmpty()) {
			...
			return worldIn.setBlockState(pos, ASDecoModGarden.CHOUZU_GRA_4.getDefaultState());
		}
			...
			return worldIn.setBlockState(pos, ASDecoModGarden.CHOUZU_GRA_1.getDefaultState());
		}
		return true;
	}
