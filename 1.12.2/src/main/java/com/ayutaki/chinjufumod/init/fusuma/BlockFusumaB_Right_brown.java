...
public abstract class BlockFusumaB_Right_brown extends BlockFacingSapo {

	public abstract boolean isOpen();

	public BlockFusumaB_Right_brown(Material material) {
		super(material);
	...
	public boolean onBlockActivated(World worldIn, BlockPos pos, IBlockState state, EntityPlayer playerIn,
		...
		if (playerIn.isSneaking()) {
			...
			worldIn.playSound(null, pos, SoundsHandler.FUSUMA, SoundCategory.BLOCKS, 1.0F, 1.0F);
			return worldIn.setBlockState(pos, ASDecoModFusuma.FUSUMAB_OR_brown.getDefaultState().withProperty(FACING, state.getValue(FACING)));
		}
	}
