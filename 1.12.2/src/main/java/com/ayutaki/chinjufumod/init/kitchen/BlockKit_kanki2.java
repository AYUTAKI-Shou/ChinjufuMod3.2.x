...
public class BlockKit_kanki2 extends BlockFacingSapo {

	public static final PropertyInteger ON = PropertyInteger.create("on", 1, 2);

	public BlockKit_kanki2() {
		super(Material.WOOD);
	...
	public boolean onBlockActivated(World worldIn, BlockPos pos, IBlockState state, EntityPlayer playerIn, EnumHand hand, EnumFacing facing,
		...
		if (playerIn.isSneaking()) {
			...
			return worldIn.setBlockState(pos,ASDecoModKitchen.KIT_KANKI_3
	...
	public Item getItemDropped(IBlockState state, Random rand, int fortune) {
		...
		return new ItemStack(ASDecoModKitchen.KIT_KANKI_1).getItem();
	}
	...
	public ItemStack getPickBlock(IBlockState state, RayTraceResult target, World world, BlockPos pos, EntityPlayer player) {
		...
		return new ItemStack(ASDecoModKitchen.KIT_KANKI_1);
	}
