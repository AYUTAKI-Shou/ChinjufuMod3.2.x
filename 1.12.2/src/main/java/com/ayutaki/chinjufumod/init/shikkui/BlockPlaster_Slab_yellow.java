...
public abstract class BlockPlaster_Slab_yellow extends BlockSlab {

	public static final PropertyInteger CRA = PropertyInteger.create("cra", 1, 2);

	public BlockPlaster_Slab_yellow(String unlocalizedName) {
		super(Material.WOOD);
	...
	public Item getItemDropped(IBlockState state, Random rand, int fortune) {
		return Item.getItemFromBlock(ASDecoModPlaster.SHIKKUI_SH_yellow);
	}
