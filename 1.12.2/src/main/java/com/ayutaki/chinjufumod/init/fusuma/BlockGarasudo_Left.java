...
public abstract class BlockGarasudo_Left extends BlockFacingSapo {

	public abstract boolean isOpen();

	public BlockGarasudo_Left(Material material) {
		super(material);
	...
	public boolean onBlockActivated(World worldIn, BlockPos pos, IBlockState state, EntityPlayer playerIn,
		...
		if (playerIn.isSneaking()) {
			...
			worldIn.playSound(null, pos, SoundsHandler.HIKIDO, SoundCategory.BLOCKS, 1.0F, 1.0F);
			return worldIn.setBlockState(pos, ASDecoModFusuma.GARASUDO_OL.getDefaultState().withProperty(FACING, state.getValue(FACING)));
		}
	}
