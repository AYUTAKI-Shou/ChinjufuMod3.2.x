...
public class BlockFuton_C_pink extends BlockFuton_pink {
	...
	public BlockFuton_C_pink(Material material, String unlocalizedName) {
		super(material);
	...
	public boolean onBlockActivated(World worldIn, BlockPos pos, IBlockState state, EntityPlayer playerIn,
		...
		if (playerIn.isSneaking()) {
				...
				return worldIn.setBlockState(pos, ASDecoModTatami.FUTON_O_pink.getDefaultState()
