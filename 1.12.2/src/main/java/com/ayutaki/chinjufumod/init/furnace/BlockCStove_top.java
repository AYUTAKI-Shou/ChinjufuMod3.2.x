...
public class BlockCStove_top extends BlockContainer {
	...
	public BlockCStove_top(boolean isBurning, String name) {
		super(Material.WOOD);
	...
	public Item getItemDropped(IBlockState state, Random rand, int fortune) {
		return Item.getItemFromBlock(ChinjufuModSchool.CSTOVE_top);
	}
	...
	public boolean onBlockActivated(World worldIn, BlockPos pos, IBlockState state, EntityPlayer playerIn,
		...
		else if (worldIn.getBlockState(new BlockPos(i, j - 1, k)).getBlock() == ChinjufuModSchool.CSTOVE_bot) {
	...
	public static void setState(boolean active, World worldIn, BlockPos pos) {
		...
		if (active)
		{
			worldIn.setBlockState(pos, ChinjufuModSchool.LIT_CSTOVE_top.getDefaultState().withProperty(FACING, iblockstate.getValue(FACING)), 3);
			worldIn.setBlockState(pos, ChinjufuModSchool.LIT_CSTOVE_top.getDefaultState().withProperty(FACING, iblockstate.getValue(FACING)), 3);
		}
		else
		{
			worldIn.setBlockState(pos, ChinjufuModSchool.CSTOVE_top.getDefaultState().withProperty(FACING, iblockstate.getValue(FACING)), 3);
			worldIn.setBlockState(pos, ChinjufuModSchool.CSTOVE_top.getDefaultState().withProperty(FACING, iblockstate.getValue(FACING)), 3);
		}
	...
	public ItemStack getItem(World worldIn, BlockPos pos, IBlockState state) {
		return new ItemStack(ChinjufuModSchool.CSTOVE_top);
	}
	...
	public void addInformation(ItemStack stack, @Nullable World playerIn, List<String> tooltip, ITooltipFlag advanced) {
		...
		tooltip.add(I18n.format("tips.tile.block_cstove_top.name", meta));
	}
}
