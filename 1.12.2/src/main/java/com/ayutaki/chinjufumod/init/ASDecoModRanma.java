...
public class ASDecoModRanma {
	...
	public static Block RANMA_oak, RANMA_aca, RANMA_bir, RANMA_doak, RANMA_jun, RANMA_spru;
	public static Block RANMA_oak_1, RANMA_aca_1, RANMA_bir_1, RANMA_doak_1, RANMA_jun_1, RANMA_spru_1;

	public static Block RANMAB_oak, RANMAB_aca, RANMAB_bir, RANMAB_doak, RANMAB_jun, RANMAB_spru;
	public static Block RANMAB_oak_1, RANMAB_aca_1, RANMAB_bir_1, RANMAB_doak_1, RANMAB_jun_1, RANMAB_spru_1;

	public static Block RANMAC_oak, RANMAC_aca, RANMAC_bir, RANMAC_doak, RANMAC_jun, RANMAC_spru;
	public static Block RANMAC_oak_1, RANMAC_aca_1, RANMAC_bir_1, RANMAC_doak_1, RANMAC_jun_1, RANMAC_spru_1;

	public static Block KANKI_oak, KANKI_aca, KANKI_bir, KANKI_doak, KANKI_jun, KANKI_spru;
	public static Block KANKI_oak_1, KANKI_aca_1, KANKI_bir_1, KANKI_doak_1, KANKI_jun_1, KANKI_spru_1;

	public static Block KOUSHI_oak, KOUSHI_aca, KOUSHI_bir,	KOUSHI_doak, KOUSHI_jun, KOUSHI_spru;
	public static Block KOUSHI_oak_1, KOUSHI_aca_1, KOUSHI_bir_1,	KOUSHI_doak_1, KOUSHI_jun_1, KOUSHI_spru_1;
