...
public class BlockSakeJuku_Gla_1 extends Block {

	public BlockSakeJuku_Gla_1() {
		super(Material.WOOD);
	...
	public boolean onBlockActivated(World worldIn, BlockPos pos, IBlockState state, EntityPlayer playerIn, EnumHand hand, EnumFacing facing,
		...
		if (!itemstack.isEmpty()) {
			...
			return worldIn.setBlockState(pos, ASDecoModHakkou.JUKUSAKEGLA_2.getDefaultState());
		}
    	return true;
	}
