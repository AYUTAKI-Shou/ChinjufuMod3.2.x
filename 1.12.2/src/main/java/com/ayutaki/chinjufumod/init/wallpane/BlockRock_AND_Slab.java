...
public abstract class BlockRock_AND_Slab extends BlockSlab {

	public BlockRock_AND_Slab(String unlocalizedName) {
	...
	public Item getItemDropped(IBlockState state, Random rand, int fortune) {
		return Item.getItemFromBlock(ASDecoModWallPane.RAND_SlabHalf);
	}
