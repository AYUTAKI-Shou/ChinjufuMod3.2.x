...
public class EntityRyusei extends KansaikiThrowable {

	public static final DataParameter<Float> THROWER_X = EntityDataManager.<Float>createKey(EntityRyusei.class,
			DataSerializers.FLOAT);
	public static final DataParameter<Float> THROWER_Y = EntityDataManager.<Float>createKey(EntityRyusei.class,
			DataSerializers.FLOAT);
	public static final DataParameter<Float> THROWER_Z = EntityDataManager.<Float>createKey(EntityRyusei.class,
			DataSerializers.FLOAT);
	public static final DataParameter<Float> YAW = EntityDataManager.<Float>createKey(EntityRyusei.class,
			DataSerializers.FLOAT);
	public static final DataParameter<ItemStack> STACK = EntityDataManager.<ItemStack>createKey(EntityRyusei.class,
			DataSerializers.ITEM_STACK);

	public EntityRyusei(World worldIn) {
		super(worldIn, "kansaiki");
	}

	public EntityRyusei(World worldIn, EntityLivingBase thrower, ItemStack stack) {
	...
	public MaterialDefinition getMaterialDefinition() {
		...
		try {
			md = ((ItemRyusei) getItemStack().getItem()).getMaterialDefinition();
	...
	public void setItemStack(ItemStack stack) {
		if (stack == null || stack.isEmpty() || !(stack.getItem() instanceof ItemRyusei)) {
