...
public class BlockBoxH_Flour extends BlockBox_Flour {

	public BlockBoxH_Flour(String unlocalizedName) {
	...
	public List<ItemStack> getDrops(IBlockAccess world, BlockPos pos, IBlockState state, int fortune) {
		List<ItemStack> stack = new ArrayList<ItemStack>();
	        ...
	        stack.add(new ItemStack(Items.WHEAT, 8, this.damageDropped(state)));
	        return stack;
