...
public class BlockKit_cheese_OAA extends BlockFacingSapo {
	...
	public void updateTick(World world, BlockPos pos, IBlockState state, Random random) {
		...
		if (true) {
			...
			world.setBlockState(pos, ASDecoModKitchen.CHEESE_OBB
	...
	public boolean onBlockActivated(World worldIn, BlockPos pos, IBlockState state, EntityPlayer playerIn, EnumHand hand, EnumFacing side,
		...
		if (itemstack.isEmpty()) {
			...
			return worldIn.setBlockState(pos, ASDecoModKitchen.CHEESE_OOA.getDefaultState()
			...
			return worldIn.setBlockState(pos, ASDecoModKitchen.CHEESE_AAA
					.getDefaultState().withProperty(FACING, state.getValue(FACING)));
		}
			...
			return worldIn.setBlockState(pos, ASDecoModKitchen.CHEESE_BAA
					.getDefaultState().withProperty(FACING, state.getValue(FACING)));
		}
