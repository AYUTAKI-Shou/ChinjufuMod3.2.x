...
public class BlockChouzubachi_kara extends Block {

	public BlockChouzubachi_kara() {
		super(Material.WOOD);
	...
	public boolean onBlockActivated(World worldIn, BlockPos pos, IBlockState state, EntityPlayer playerIn,
		...
		if (itemstack.isEmpty()) {
			...
			return worldIn.setBlockState(pos, ASDecoModGarden.CHOUZUBACHI_kara.getDefaultState());
		}
			...
			return worldIn.setBlockState(pos, ASDecoModGarden.CHOUZUBACHI_1.getDefaultState());
		}
		return true;
	}
