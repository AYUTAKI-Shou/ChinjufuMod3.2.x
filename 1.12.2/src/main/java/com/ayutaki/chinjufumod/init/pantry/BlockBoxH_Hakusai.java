...
public class BlockBoxH_Hakusai extends BlockBox_Hakusai {

	public BlockBoxH_Hakusai(String unlocalizedName) {
	...
	public List<ItemStack> getDrops(IBlockAccess world, BlockPos pos, IBlockState state, int fortune) {
		List<ItemStack> stack = new ArrayList<ItemStack>();
	        ...
	        stack.add(new ItemStack(ChinjufuModItemFoods.FOOD_HAKUSAI, 2, this.damageDropped(state)));
	        return stack;
