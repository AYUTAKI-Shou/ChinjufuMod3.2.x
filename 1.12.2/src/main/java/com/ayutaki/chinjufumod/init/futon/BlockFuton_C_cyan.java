...
public class BlockFuton_C_cyan extends BlockFuton_cyan {
	...
	public BlockFuton_C_cyan(Material material, String unlocalizedName) {
		super(material);
	...
	public boolean onBlockActivated(World worldIn, BlockPos pos, IBlockState state, EntityPlayer playerIn,
		...
		if (playerIn.isSneaking()) {
				...
				return worldIn.setBlockState(pos, ASDecoModTatami.FUTON_O_cyan.getDefaultState()
