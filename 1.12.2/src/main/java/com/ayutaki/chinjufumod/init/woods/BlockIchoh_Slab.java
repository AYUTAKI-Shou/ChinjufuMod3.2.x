...
public abstract class BlockIchoh_Slab extends BlockSlab {

	public BlockIchoh_Slab(String unlocalizedName) {
		super(Material.WOOD);
	...
	public Item getItemDropped(IBlockState state, Random rand, int fortune) {
		return Item.getItemFromBlock(ASDecoModWoods.ICHOH_SlabHalf);
	}
