...
public class BlockBoxH_Rice extends BlockBox_Rice {

	public BlockBoxH_Rice(String unlocalizedName) {
	...
	public List<ItemStack> getDrops(IBlockAccess world, BlockPos pos, IBlockState state, int fortune) {
		List<ItemStack> stack = new ArrayList<ItemStack>();
	        ...
	        stack.add(new ItemStack(TTimeItems.KOME, 8, this.damageDropped(state)));
	        return stack;
