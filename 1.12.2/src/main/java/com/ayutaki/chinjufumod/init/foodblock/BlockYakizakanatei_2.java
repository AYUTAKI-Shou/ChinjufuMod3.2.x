...
public class BlockYakizakanatei_2 extends BlockFacingSapo {
	...
	public boolean onBlockActivated(World worldIn, BlockPos pos, IBlockState state, EntityPlayer playerIn,
		...
		if (!itemstack.isEmpty()) {
			...
			return worldIn.setBlockState(pos, ChinjufuModFoodBlocks.YAKIZAKANATEI_3.getDefaultState()
