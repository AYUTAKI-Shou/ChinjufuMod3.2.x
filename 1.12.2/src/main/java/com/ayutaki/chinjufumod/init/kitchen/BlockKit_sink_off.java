...
public class BlockKit_sink_off extends BlockFacingSapo {

	public BlockKit_sink_off()  {
		super(Material.WOOD);
	...
	public boolean onBlockActivated(World worldIn, BlockPos pos, IBlockState state, EntityPlayer playerIn,
		...
		if (worldIn.getBlockState(new BlockPos(i, j - 2, k)).getBlock() == Blocks.WATER) {
			...
			if (!itemstack.isEmpty()) {
				...
				worldIn.playSound(null, pos, SoundsHandler.WATER_START, SoundCategory.BLOCKS, 1.0F, 1.0F);
				return worldIn.setBlockState(pos, ASDecoModKitchen.KIT_SINK2.getDefaultState()
