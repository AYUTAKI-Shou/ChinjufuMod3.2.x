...
public class BlockFuton_O_lightb extends BlockFuton_lightb {
	...
	public BlockFuton_O_lightb(Material material, String unlocalizedName) {
		super(material);
	...
	public boolean onBlockActivated(World worldIn, BlockPos pos, IBlockState state, EntityPlayer playerIn,
		...
		if (playerIn.isSneaking()) {
				...
				return worldIn.setBlockState(pos, ASDecoModTatami.FUTON_C_lightb.getDefaultState()
