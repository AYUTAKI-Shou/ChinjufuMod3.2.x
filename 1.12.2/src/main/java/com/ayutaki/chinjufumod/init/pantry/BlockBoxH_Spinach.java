...
public class BlockBoxH_Spinach extends BlockBox_Spinach {

	public BlockBoxH_Spinach(String unlocalizedName) {
	...
	public List<ItemStack> getDrops(IBlockAccess world, BlockPos pos, IBlockState state, int fortune) {
		List<ItemStack> stack = new ArrayList<ItemStack>();
	        ...
	        stack.add(new ItemStack(ChinjufuModItemFoods.FOOD_SPINACH, 8, this.damageDropped(state)));
	        return stack;
