...
import com.ayutaki.chinjufumod.init.mamiya.BlockCafeTable_ich;
import com.ayutaki.chinjufumod.init.mamiya.BlockCafeTable_j;
import com.ayutaki.chinjufumod.init.mamiya.BlockCafeTable_kae;
import com.ayutaki.chinjufumod.init.mamiya.BlockCafeTable_s;
import com.ayutaki.chinjufumod.init.mamiya.BlockCafeTable_saku;
...
public class ChinjufuModMamiya {
	...
	public static void init() {
		...
		CAFETABLE_saku = new BlockCafeTable_saku(Material.WOOD).setRegistryName("block_cafetable_saku").setUnlocalizedName("block_cafetable_saku").setCreativeTab(ChinjufuModTabs.tab_chinjufumod);
		CAFETABLE_kae = new BlockCafeTable_kae(Material.WOOD).setRegistryName("block_cafetable_kae").setUnlocalizedName("block_cafetable_kae").setCreativeTab(ChinjufuModTabs.tab_chinjufumod);
		CAFETABLE_ich = new BlockCafeTable_ich(Material.WOOD).setRegistryName("block_cafetable_ich").setUnlocalizedName("block_cafetable_ich").setCreativeTab(ChinjufuModTabs.tab_chinjufumod);
		...
		LOGCHAIR_saku = new BlockLogChair(Material.WOOD).setRegistryName("block_logchair_saku").setUnlocalizedName("block_logchair_saku").setCreativeTab(ChinjufuModTabs.tab_chinjufumod);
		LOGCHAIR_kae = new BlockLogChair(Material.WOOD).setRegistryName("block_logchair_kae").setUnlocalizedName("block_logchair_kae").setCreativeTab(ChinjufuModTabs.tab_chinjufumod);
		LOGCHAIR_ich = new BlockLogChair(Material.WOOD).setRegistryName("block_logchair_ich").setUnlocalizedName("block_logchair_ich").setCreativeTab(ChinjufuModTabs.tab_chinjufumod);
	...
	public static void register() {
		...
		registerBlock(CAFETABLE_saku);
		registerBlock(CAFETABLE_kae);
		registerBlock(CAFETABLE_ich);
		...
		registerBlock(LOGCHAIR_saku);
		registerBlock(LOGCHAIR_kae);
		registerBlock(LOGCHAIR_ich);
	...
	public static void registerRenders() {
		...
		registerRender(CAFETABLE_saku);
		registerRender(CAFETABLE_kae);
		registerRender(CAFETABLE_ich);
		...
		registerRender(LOGCHAIR_saku);
		registerRender(LOGCHAIR_kae);
		registerRender(LOGCHAIR_ich);
