...
public class BlockKit_cheese_OBB extends BlockFacingSapo {
	...
	public boolean onBlockActivated(World worldIn, BlockPos pos, IBlockState state, EntityPlayer playerIn, EnumHand hand, EnumFacing side,
		...
		if (itemstack.isEmpty()) {
			...
			return worldIn.setBlockState(pos, ASDecoModKitchen.CHEESE_OOB.getDefaultState()
			...
			return worldIn.setBlockState(pos, ASDecoModKitchen.CHEESE_BBB
					.getDefaultState().withProperty(FACING, state.getValue(FACING)));
		}
	...
	public List<ItemStack> getDrops(IBlockAccess world, BlockPos pos, IBlockState state, int fortune) {
		List<ItemStack> stack = new ArrayList<ItemStack>();
			...
			stack.add(new ItemStack(ASDecoModHakkou.CHEESE_1, 2, this.damageDropped(state)));
