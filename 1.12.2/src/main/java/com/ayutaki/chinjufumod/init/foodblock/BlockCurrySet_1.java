...
public class BlockCurrySet_1 extends BlockFacingSapo {
	...
	public boolean onBlockActivated(World worldIn, BlockPos pos, IBlockState state, EntityPlayer playerIn,
		...
		if (!itemstack.isEmpty()) {
			...
			return worldIn.setBlockState(pos, ChinjufuModFoodBlocks.CURRYSET_2.getDefaultState()
