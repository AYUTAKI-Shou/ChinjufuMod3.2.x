...
import com.ayutaki.chinjufumod.init.items.ItemIne;
...
import com.ayutaki.chinjufumod.init.items.ItemNyusan;
import com.ayutaki.chinjufumod.init.items.ItemRennet;
...
public class TTimeItems {
	...
	/* 追加するアイテムの宣言 Declare items to add. */
	public static Item CHABA_GREEN, CHABA_RED;
	public static Item TUMICHABA;

	public static Item SHIO, NIGARI, SAKEKASU;
	public static Item KOUBO, MUSHIGOME, KOMEKOUJI, SHUBO, MORO, NYUSAN, RENNET;

	public static Item NIMAME, MISO;

	public static Item INEWARA, INE, KOME, SAYA, SOY, KOMUGI, BUTTER;

	public static Item KIJI_BUN, KIJI_BURG, KIJI_SCONE, KIJI_SENBEI, KIJI_PIZA,
						PASTA_nama, PASTA_sara, PIZZA_nama;
	...
	public static Item SEEDS_CABE, SEEDS_HAKUSAI, SEEDS_CORN, SEEDS_ONION, SEEDS_RICE,
						SEEDS_SOY, SEEDS_SPINACH, SEEDS_TOMATO, SEEDS_CHERRY;
	...
	public static void init() {
		...
		NYUSAN = new ItemNyusan().setRegistryName("item_nyusan").setUnlocalizedName("item_nyusan").setCreativeTab(ChinjufuModTabs.tab_teatime);
		RENNET = new ItemRennet().setRegistryName("item_rennet").setUnlocalizedName("item_rennet").setCreativeTab(ChinjufuModTabs.tab_teatime);
		...
		INEWARA = new Item().setRegistryName("item_inewara").setUnlocalizedName("item_inewara").setCreativeTab(ChinjufuModTabs.tab_teatime);
		INE = new ItemIne().setRegistryName("item_ine").setUnlocalizedName("item_ine").setCreativeTab(ChinjufuModTabs.tab_teatime);
		...
		KIJI_PIZA = new Item().setRegistryName("item_kiji_pizza").setUnlocalizedName("item_kiji_pizza").setCreativeTab(ChinjufuModTabs.tab_teatime);

		PIZZA_nama = new Item().setRegistryName("item_food_pizza_n").setUnlocalizedName("item_food_pizza_n").setCreativeTab(ChinjufuModTabs.tab_teatime);
		...
		SEEDS_CHERRY = new ItemSeeds(ASDecoModWoods.CHERRY_me, Blocks.FARMLAND).setRegistryName("item_seeds_cherry").setUnlocalizedName("item_seeds_cherry");
	...
	public static void register() {
		...
		registerItem(KIJI_PIZA);
		registerItem(PIZZA_nama);
	...
	* Register rendering of Items in drop and inventory. From here↓*/
	public static void registerRenders() {
		...
		registerRender(KIJI_PIZA);
		registerRender(PIZZA_nama);
