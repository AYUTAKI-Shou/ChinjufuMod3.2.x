...
import com.ayutaki.chinjufumod.init.woods.treegen.WorldGenTreeOakKareBig;
...
public class BlockOakKare_nae extends BlockBush implements IGrowable {

	/* 成長の段階を持たせる */
	public static final PropertyInteger STAGE = PropertyInteger.create("stage", 0, 1);

	public BlockOakKare_nae() {
	...
	public void generateTree(World worldIn, BlockPos pos, IBlockState state, Random rand) {
		...
		WorldGenerator worldgenerator =
				(WorldGenerator)(rand.nextInt(10) == 0 ? new WorldGenTreeOakKareBig(true) : new WorldGenTreeOakKare(true));
