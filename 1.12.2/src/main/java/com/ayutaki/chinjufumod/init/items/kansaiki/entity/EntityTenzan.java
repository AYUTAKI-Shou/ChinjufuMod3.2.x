...
public class EntityTenzan extends KansaikiThrowable {

	public static final DataParameter<Float> THROWER_X = EntityDataManager.<Float>createKey(EntityTenzan.class,
			DataSerializers.FLOAT);
	public static final DataParameter<Float> THROWER_Y = EntityDataManager.<Float>createKey(EntityTenzan.class,
			DataSerializers.FLOAT);
	public static final DataParameter<Float> THROWER_Z = EntityDataManager.<Float>createKey(EntityTenzan.class,
			DataSerializers.FLOAT);
	public static final DataParameter<Float> YAW = EntityDataManager.<Float>createKey(EntityTenzan.class,
			DataSerializers.FLOAT);
	public static final DataParameter<ItemStack> STACK = EntityDataManager.<ItemStack>createKey(EntityTenzan.class,
			DataSerializers.ITEM_STACK);

	public EntityTenzan(World worldIn) {
		super(worldIn, "kansaiki");
	}

	public EntityTenzan(World worldIn, EntityLivingBase thrower, ItemStack stack) {
	...
	public MaterialDefinition getMaterialDefinition() {
		...
		try {
			md = ((ItemTenzan) getItemStack().getItem()).getMaterialDefinition();
	...
	public void setItemStack(ItemStack stack) {
		if (stack == null || stack.isEmpty() || !(stack.getItem() instanceof ItemTenzan)) {
