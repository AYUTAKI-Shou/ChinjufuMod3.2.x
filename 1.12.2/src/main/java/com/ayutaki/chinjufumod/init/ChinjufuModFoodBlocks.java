...
public class ChinjufuModFoodBlocks {
	...
	public static Block NABE_kara, NABE_kara_nolid;
	...
	public static Block ZUNDOU_MIZU, ZUNDOU_OYU, PASTANABE_full, PASTANABE_full2cold, PASTANABE_boil, PASTANABE_boil2cold;
	public static Block TOMATOSAU_nama, TOMATOSAU_bake;
	public static Block PASTATOMA_1, PASTATOMA_2, PASTATOMA_3, PASTATOMA_kara;
	public static Block PASTACHEESE_1, PASTACHEESE_2, PASTACHEESE_3;
	...
	public static Block PIZZA_1, PIZZA_2, PIZZA_3, PIZZA_4, PIZZA_kara;
	...
	public static void init() {
		...
		NABE_boil = new BlockNabe_boil_1().setRegistryName("block_food_nabe_b").setUnlocalizedName("block_food_nabe_b");
		...
		PASTANABE_full2cold = new BlockPastaNabe_full2cold().setRegistryName("block_food_pastanabe_fs").setUnlocalizedName("block_food_pastanabe_fs");
		PASTANABE_boil = new BlockPastaNabe_boil().setRegistryName("block_food_pastanabe_b").setUnlocalizedName("block_food_pastanabe_b");
 		PASTANABE_boil2cold = new BlockPastaNabe_boil2cold().setRegistryName("block_food_pastanabe_bs").setUnlocalizedName("block_food_pastanabe_bs");
		...
		PASTACHEESE_1 = new BlockPastaCheese_1().setRegistryName("block_food_pastacheese_1").setUnlocalizedName("block_food_pastacheese_1").setCreativeTab(ChinjufuModTabs.tab_teatime);
		PASTACHEESE_2 = new BlockPastaCheese_2().setRegistryName("block_food_pastacheese_2").setUnlocalizedName("block_food_pastacheese_2");
		PASTACHEESE_3 = new BlockPastaCheese_3().setRegistryName("block_food_pastacheese_3").setUnlocalizedName("block_food_pastacheese_3");
		...
		PIZZA_1 = new BlockPizza_1().setRegistryName("block_food_pizza_1").setUnlocalizedName("block_food_pizza_1").setCreativeTab(ChinjufuModTabs.tab_teatime);
		PIZZA_2 = new BlockPizza_2().setRegistryName("block_food_pizza_2").setUnlocalizedName("block_food_pizza_2");
		PIZZA_3 = new BlockPizza_3().setRegistryName("block_food_pizza_3").setUnlocalizedName("block_food_pizza_3");
		PIZZA_4 = new BlockPizza_4().setRegistryName("block_food_pizza_4").setUnlocalizedName("block_food_pizza_4");
		PIZZA_kara = new BlockPizza_kara().setRegistryName("block_food_pizza_k").setUnlocalizedName("block_food_pizza_k");
	...
	public static void register() {
		...
		registerBlock(PASTANABE_full2cold);
		registerBlock(PASTANABE_boil);
		registerBlock(PASTANABE_boil2cold);
		...
		registerBlock(PASTACHEESE_1);
		registerBlock(PASTACHEESE_2);
		registerBlock(PASTACHEESE_3);
		...
		registerBlock(PIZZA_1);
		registerBlock(PIZZA_2);
		registerBlock(PIZZA_3);
		registerBlock(PIZZA_4);
		registerBlock(PIZZA_kara);
	...
	public static void registerRenders() {
		...
		registerRender(PIZZA_1);
		registerRender(PIZZA_2);
		registerRender(PIZZA_3);
		registerRender(PIZZA_4);
		registerRender(PIZZA_kara);
	}
