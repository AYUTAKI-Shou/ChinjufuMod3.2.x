...
public abstract class BlockRock_GRA_Slab extends BlockSlab {

	public BlockRock_GRA_Slab(String unlocalizedName) {
		super(Material.ROCK);
	...
	public Item getItemDropped(IBlockState state, Random rand, int fortune) {
		return Item.getItemFromBlock(ASDecoModWallPane.RGRA_SlabHalf);
	}
