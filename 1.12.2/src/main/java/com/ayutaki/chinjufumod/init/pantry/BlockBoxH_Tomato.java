...
public class BlockBoxH_Tomato extends BlockBox_Tomato {

	public BlockBoxH_Tomato(String unlocalizedName) {
	...
	public List<ItemStack> getDrops(IBlockAccess world, BlockPos pos, IBlockState state, int fortune) {
		List<ItemStack> stack = new ArrayList<ItemStack>();
	        ...
	        stack.add(new ItemStack(ChinjufuModItemFoods.FOOD_TOMATO, 8, this.damageDropped(state)));
	        return stack;
