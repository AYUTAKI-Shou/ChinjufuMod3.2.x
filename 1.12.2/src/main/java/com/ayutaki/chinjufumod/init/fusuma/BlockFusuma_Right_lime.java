...
public abstract class BlockFusuma_Right_lime extends BlockFacingSapo {

	public abstract boolean isOpen();

	public BlockFusuma_Right_lime(Material material) {
		super(material);
	...
	public boolean onBlockActivated(World worldIn, BlockPos pos, IBlockState state, EntityPlayer playerIn,
		...
		if (playerIn.isSneaking()) {
			...
			worldIn.playSound(null, pos, SoundsHandler.FUSUMA, SoundCategory.BLOCKS, 1.0F, 1.0F);
			return worldIn.setBlockState(pos, ASDecoModFusuma.FUSUMA_OR_lime.getDefaultState().withProperty(FACING, state.getValue(FACING)));
		}
	}
