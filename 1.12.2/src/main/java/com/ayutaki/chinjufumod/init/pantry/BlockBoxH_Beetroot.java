...
public class BlockBoxH_Beetroot extends BlockBox_Beetroot {

	public BlockBoxH_Beetroot(String unlocalizedName) {
	...
	public List<ItemStack> getDrops(IBlockAccess world, BlockPos pos, IBlockState state, int fortune) {
		List<ItemStack> stack = new ArrayList<ItemStack>();
	        ...
	        stack.add(new ItemStack(Items.BEETROOT, 8, this.damageDropped(state)));
	        return stack;
