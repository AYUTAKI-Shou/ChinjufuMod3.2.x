...
public class BlockFuton_C_purple extends BlockFuton_purple {
	...
	public BlockFuton_C_purple(Material material, String unlocalizedName) {
		super(material);
	...
	public boolean onBlockActivated(World worldIn, BlockPos pos, IBlockState state, EntityPlayer playerIn,
		...
		if (playerIn.isSneaking()) {
				...
				return worldIn.setBlockState(pos, ASDecoModTatami.FUTON_O_purple.getDefaultState()
