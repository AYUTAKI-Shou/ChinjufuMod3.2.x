...
public abstract class BlockNamakoB_Slab_green extends BlockSlab {

	public static final PropertyInteger CRA = PropertyInteger.create("cra", 1, 2);

	public BlockNamakoB_Slab_green(String unlocalizedName) {
		super(Material.WOOD);
	...
	public Item getItemDropped(IBlockState state, Random rand, int fortune) {
		return Item.getItemFromBlock(ASDecoModNamako.NAMAKOB_SH_green);
	}
