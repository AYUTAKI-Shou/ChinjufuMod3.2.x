...
public class BlockKit_cheese_OOA extends BlockFacingSapo {
	...
	public void updateTick(World world, BlockPos pos, IBlockState state, Random random) {
		...
		if (true) {
			...
			world.setBlockState(pos, ASDecoModKitchen.CHEESE_OOB
	...
	public boolean onBlockActivated(World worldIn, BlockPos pos, IBlockState state, EntityPlayer playerIn, EnumHand hand, EnumFacing side,
		...
		if (itemstack.isEmpty()) {
			...
			.inventory.addItemStackToInventory(new ItemStack(Item.getItemFromBlock(ASDecoModHakkou.CURD), 1));
			worldIn.playSound(null, pos, SoundEvents.ENTITY_ITEM_PICKUP, SoundCategory.PLAYERS, 0.2F, 2.0F);

			return worldIn.setBlockState(pos, ASDecoModKitchen.CHEESE_TANA.getDefaultState()
			...
			return worldIn.setBlockState(pos, ASDecoModKitchen.CHEESE_OAA
					.getDefaultState().withProperty(FACING, state.getValue(FACING)));
		}
			...
			return worldIn.setBlockState(pos, ASDecoModKitchen.CHEESE_OBA
					.getDefaultState().withProperty(FACING, state.getValue(FACING)));
		}
	...
	public List<ItemStack> getDrops(IBlockAccess world, BlockPos pos, IBlockState state, int fortune) {
		List<ItemStack> stack = new ArrayList<ItemStack>();
			...
			stack.add(new ItemStack(ASDecoModHakkou.CURD, 1, this.damageDropped(state)));
