...
public class ASDecoModPlaster {
	...
	public static void init() {
		...
		DIRTWALL_stairs = new BlockDirtwallStairs("block_dirtwall_st", DIRTWALL.getDefaultState());
