...
public abstract class BlockFusumaB_Left_orange extends BlockFacingSapo {

	public abstract boolean isOpen();

	public BlockFusumaB_Left_orange(Material material) {
		super(material);
	...
	public boolean onBlockActivated(World worldIn, BlockPos pos, IBlockState state, EntityPlayer playerIn,
		...
		if (playerIn.isSneaking()) {
			...
			worldIn.playSound(null, pos, SoundsHandler.FUSUMA, SoundCategory.BLOCKS, 1.0F, 1.0F);
			return worldIn.setBlockState(pos, ASDecoModFusuma.FUSUMAB_OL_orange.getDefaultState().withProperty(FACING, state.getValue(FACING)));
		}
	}
