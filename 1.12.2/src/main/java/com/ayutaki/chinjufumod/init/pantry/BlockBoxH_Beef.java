...
public class BlockBoxH_Beef extends BlockBox_Beef {

	public BlockBoxH_Beef(String unlocalizedName) {
	...
	public List<ItemStack> getDrops(IBlockAccess world, BlockPos pos, IBlockState state, int fortune) {
		List<ItemStack> stack = new ArrayList<ItemStack>();
	        ...
	        stack.add(new ItemStack(Items.BEEF, 8, this.damageDropped(state)));
	        return stack;
