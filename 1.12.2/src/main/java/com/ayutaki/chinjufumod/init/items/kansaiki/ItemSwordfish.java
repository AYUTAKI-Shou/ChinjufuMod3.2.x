...
public class ItemSwordfish extends ExtendedItem {

	protected final MaterialDefinition materialDefinition;
	protected final boolean unbreakable;

	public ItemSwordfish(ToolMaterial material) {
		this(material, false);
	}

	public ItemSwordfish(ToolMaterial material, boolean unbreakable) {
		super();
	 ...
	 * {@link EntitySwordfish#getImpactDamage}
	 */
	@Override
	public float getHitDamage() {

		return Math.max(1f, (4.0f));
	}
	...
	public ActionResult<ItemStack> onItemRightClick(World worldIn, EntityPlayer playerIn, EnumHand hand) {
		...
		if (hand == EnumHand.MAIN_HAND) {
			...
			if (playerIn.capabilities.isCreativeMode || KansaikiHelpers.consumeInventoryItem(playerIn, this)) {
				...
				if (!worldIn.isRemote) {
					EntitySwordfish kansaiki = new EntitySwordfish(worldIn, playerIn, throwStack);
