...
public class BlockCider_Bot_4 extends BlockFacingSapo {

	public BlockCider_Bot_4() {
		super(Material.WOOD);
		...
		if (item != TTimeItems.Item_DRINKGLASS) {
			...
			if (itemstack.isEmpty()) {
				((EntityPlayer) playerIn).inventory
						.addItemStackToInventory(new ItemStack(Item.getItemFromBlock(ASDecoModHakkou.CIDERGLA_1)));
			}
			...
			return worldIn.setBlockState(pos, ASDecoModHakkou.CIDERBOT_kara
