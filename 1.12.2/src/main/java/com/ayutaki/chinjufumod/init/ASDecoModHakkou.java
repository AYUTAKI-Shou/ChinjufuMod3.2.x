...
import com.ayutaki.chinjufumod.init.hakkou.BlockBin_Nyusan_1;
import com.ayutaki.chinjufumod.init.hakkou.BlockBin_Nyusan_full;
import com.ayutaki.chinjufumod.init.hakkou.BlockCheese_1;
import com.ayutaki.chinjufumod.init.hakkou.BlockCheese_2;
import com.ayutaki.chinjufumod.init.hakkou.BlockCheese_3;
import com.ayutaki.chinjufumod.init.hakkou.BlockCheese_4;
import com.ayutaki.chinjufumod.init.hakkou.BlockCheese_curd;
...
import com.ayutaki.chinjufumod.init.hakkou.BlockZundou_coldmilk_1;
import com.ayutaki.chinjufumod.init.hakkou.BlockZundou_coldmilk_2;
import com.ayutaki.chinjufumod.init.hakkou.BlockZundou_coldmilk_3;
import com.ayutaki.chinjufumod.init.hakkou.BlockZundou_curd;
import com.ayutaki.chinjufumod.init.hakkou.BlockZundou_hotmilk;
import com.ayutaki.chinjufumod.init.hakkou.BlockZundou_milk;
...
public class ASDecoModHakkou {
	...
	public static Block NYUSANBIN_full, NYUSANBIN_1;
	public static Block NABE_milk, NABE_hotmilk, NABE_coldmilk_1, NABE_coldmilk_2, NABE_coldmilk_3, NABE_curd;
	public static Block CURD, CHEESE_1, CHEESE_2, CHEESE_3, CHEESE_4;
	...
	public static void init() {
		...
		NYUSANBIN_full = new BlockBin_Nyusan_full().setRegistryName("block_bin_nyusan_f").setUnlocalizedName("block_bin_nyusan_f").setCreativeTab(ChinjufuModTabs.tab_teatime);
		NYUSANBIN_1 = new BlockBin_Nyusan_1().setRegistryName("block_bin_nyusan_1").setUnlocalizedName("block_bin_nyusan_1");

		NABE_milk = new BlockZundou_milk().setRegistryName("block_nabe_milk").setUnlocalizedName("block_nabe_milk").setCreativeTab(ChinjufuModTabs.tab_teatime);
		NABE_hotmilk = new BlockZundou_hotmilk().setRegistryName("block_nabe_hotmilk").setUnlocalizedName("block_nabe_hotmilk");
		NABE_coldmilk_1 = new BlockZundou_coldmilk_1().setRegistryName("block_nabe_coldmilk1").setUnlocalizedName("block_nabe_coldmilk1");
		NABE_coldmilk_2 = new BlockZundou_coldmilk_2().setRegistryName("block_nabe_coldmilk2").setUnlocalizedName("block_nabe_coldmilk2");
		NABE_coldmilk_3 = new BlockZundou_coldmilk_3().setRegistryName("block_nabe_coldmilk3").setUnlocalizedName("block_nabe_coldmilk3");
		NABE_curd = new BlockZundou_curd().setRegistryName("block_nabe_curd").setUnlocalizedName("block_nabe_curd");

		CURD = new BlockCheese_curd().setRegistryName("block_food_cheesecurd").setUnlocalizedName("block_food_cheesecurd").setCreativeTab(ChinjufuModTabs.tab_teatime);
		CHEESE_1 = new BlockCheese_1().setRegistryName("block_food_cheese_1").setUnlocalizedName("block_food_cheese_1").setCreativeTab(ChinjufuModTabs.tab_teatime);
		CHEESE_2 = new BlockCheese_2().setRegistryName("block_food_cheese_2").setUnlocalizedName("block_food_cheese_2");
		CHEESE_3 = new BlockCheese_3().setRegistryName("block_food_cheese_3").setUnlocalizedName("block_food_cheese_3");
		CHEESE_4 = new BlockCheese_4().setRegistryName("block_food_cheese_4").setUnlocalizedName("block_food_cheese_4");
	...
	public static void register() {
		...
		registerBlock(NYUSANBIN_full);
		registerBlock(NYUSANBIN_1);

		registerBlock(NABE_milk);
		registerBlock(NABE_hotmilk);
		registerBlock(NABE_coldmilk_1);
		registerBlock(NABE_coldmilk_2);
		registerBlock(NABE_coldmilk_3);
		registerBlock(NABE_curd);

		registerBlock(CURD);
		registerBlock(CHEESE_1);
		registerBlock(CHEESE_2);
		registerBlock(CHEESE_3);
		registerBlock(CHEESE_4);
	...
	public static void registerRenders() {
		...
		registerRender(NYUSANBIN_full);
		registerRender(NYUSANBIN_1);
		registerRender(NABE_milk);
		registerRender(CURD);
		registerRender(CHEESE_1);
