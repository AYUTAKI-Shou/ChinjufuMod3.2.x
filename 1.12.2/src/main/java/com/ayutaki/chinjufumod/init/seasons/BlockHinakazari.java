...
public class BlockHinakazari extends Block {

	public static final PropertyDirection FACING = PropertyDirection.create("facing", EnumFacing.Plane.HORIZONTAL);
	public static final PropertyInteger HINA = PropertyInteger.create("hina", 1, 4);
	...
	public BlockHinakazari(Material material) {
		super(material);
		...
		this.setDefaultState(this.blockState.getBaseState().withProperty(FACING, EnumFacing.NORTH)
				.withProperty(HINA, Integer.valueOf(1)));
	}
	...
	public void addInformation(ItemStack stack, @Nullable World playerIn, List<String> tooltip, ITooltipFlag advanced) {
		...
		tooltip.add(I18n.format("tips.tile.block_hinakazari.name", meta));
	}
}
