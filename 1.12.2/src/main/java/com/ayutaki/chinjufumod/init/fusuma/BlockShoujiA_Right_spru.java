...
public abstract class BlockShoujiA_Right_spru extends BlockFacingSapo {

	public abstract boolean isOpen();

	public BlockShoujiA_Right_spru(Material material) {
		super(material);
	...
	public boolean onBlockActivated(World worldIn, BlockPos pos, IBlockState state, EntityPlayer playerIn,
		...
		if (playerIn.isSneaking()) {
			...
			worldIn.playSound(null, pos, SoundsHandler.FUSUMA, SoundCategory.BLOCKS, 1.0F, 1.0F);
			return worldIn.setBlockState(pos, ASDecoModFusuma.SHOUJIA_OR_spru.getDefaultState().withProperty(FACING, state.getValue(FACING)));
		}
	}
