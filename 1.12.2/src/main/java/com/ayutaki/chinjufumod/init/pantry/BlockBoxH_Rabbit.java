...
public class BlockBoxH_Rabbit extends BlockBox_Rabbit {

	public BlockBoxH_Rabbit(String unlocalizedName) {
	...
	public List<ItemStack> getDrops(IBlockAccess world, BlockPos pos, IBlockState state, int fortune) {
		List<ItemStack> stack = new ArrayList<ItemStack>();
	        ...
	        stack.add(new ItemStack(Items.RABBIT, 8, this.damageDropped(state)));
	        return stack;
