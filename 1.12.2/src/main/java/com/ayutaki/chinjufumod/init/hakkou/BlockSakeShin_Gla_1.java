...
public class BlockSakeShin_Gla_1 extends Block {

	public BlockSakeShin_Gla_1() {
		super(Material.WOOD);
	...
	public boolean onBlockActivated(World worldIn, BlockPos pos, IBlockState state, EntityPlayer playerIn, EnumHand hand, EnumFacing facing,
		...
		if (!itemstack.isEmpty()) {
			...
			return worldIn.setBlockState(pos, ASDecoModHakkou.SHINSAKEGLA_2.getDefaultState());
		}
    	return true;
	}
