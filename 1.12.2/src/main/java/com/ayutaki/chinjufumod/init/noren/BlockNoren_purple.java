...
public class BlockNoren_purple extends BlockFacingSapo {
	...
	public BlockNoren_purple(Material material, String unlocalizedName) {
		super(material);
	...
	public IBlockState getActualState(IBlockState state, IBlockAccess worldIn, BlockPos pos) {
			...
			boolean left = left_block.getBlock() instanceof BlockNoren_purple && left_block.getValue(FACING).equals(facing);
			boolean right = right_block.getBlock() instanceof BlockNoren_purple && right_block.getValue(FACING).equals(facing);
