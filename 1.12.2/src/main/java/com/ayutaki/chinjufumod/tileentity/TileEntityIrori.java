...
public class TileEntityIrori extends TileEntityLockable implements ITickable, ISidedInventory {
	...
	public String getName() {
		return this.hasCustomName() ? this.furnaceCustomName : "container.irori";
	}
	...
	public void update() {
		...
		if (!this.world.isRemote) {
			...
			if (flag != this.isBurning()) {
				flag1 = true;
				BlockIrori.setState(this.isBurning(), this.world, this.pos);
			}
		}
