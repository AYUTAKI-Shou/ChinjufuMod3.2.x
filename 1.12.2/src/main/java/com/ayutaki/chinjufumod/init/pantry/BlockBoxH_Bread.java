...
public class BlockBoxH_Bread extends BlockBox_Bread {

	public BlockBoxH_Bread(String unlocalizedName) {
	...
	public List<ItemStack> getDrops(IBlockAccess world, BlockPos pos, IBlockState state, int fortune) {
		List<ItemStack> stack = new ArrayList<ItemStack>();
	        ...
	        stack.add(new ItemStack(Items.BREAD, 8, this.damageDropped(state)));
	        return stack;
