...
public abstract class BlockRock_DIO_Slab extends BlockSlab {

	public BlockRock_DIO_Slab(String unlocalizedName) {
		super(Material.ROCK);
	...
	public Item getItemDropped(IBlockState state, Random rand, int fortune) {
		return Item.getItemFromBlock(ASDecoModWallPane.RDIO_SlabHalf);
	}
