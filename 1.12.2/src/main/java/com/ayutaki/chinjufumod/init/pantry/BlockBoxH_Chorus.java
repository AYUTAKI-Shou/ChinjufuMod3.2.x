...
public class BlockBoxH_Chorus extends BlockBox_Chorus {

	public BlockBoxH_Chorus(String unlocalizedName) {
	...
	public List<ItemStack> getDrops(IBlockAccess world, BlockPos pos, IBlockState state, int fortune) {
		List<ItemStack> stack = new ArrayList<ItemStack>();
	        ...
	        stack.add(new ItemStack(Items.CHORUS_FRUIT, 8, this.damageDropped(state)));
	        return stack;
